# -*- encoding: utf-8 -*-
# stub: logstash-output-email 4.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://www.elastic.co/logstash".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<mail>.freeze, ["~> 2.8"])
    ...
    s.add_dependency(%q<mail>.freeze, ["~> 2.8"])
