...
const templateSchema = exports.templateSchema = _configSchema.schema.object({
  ...
  allowAutoCreate: _configSchema.schema.maybe(_configSchema.schema.string()),
  ...
  ignoreMissingComponentTemplates: _configSchema.schema.maybe(_configSchema.schema.arrayOf(_configSchema.schema.string())),
