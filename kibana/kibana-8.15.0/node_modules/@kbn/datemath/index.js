...
const unitsMap = exports.unitsMap = {
  ms: {
    weight: 1,
    type: 'fixed',
    base: 1
...
const units = exports.units = Object.keys(unitsMap).sort((a, b) => unitsMap[b].weight - unitsMap[a].weight);
const unitsDesc = exports.unitsDesc = [...units];
const unitsAsc = exports.unitsAsc = [...units].reverse();
