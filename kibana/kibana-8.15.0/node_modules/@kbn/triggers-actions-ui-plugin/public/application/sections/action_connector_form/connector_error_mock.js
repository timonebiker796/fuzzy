...
const TestConnectorError = ({
  ...
  const preSubmitValidator = (0, _react.useCallback)(async () => {
    return {
      message: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, 'Error on pre submit validator')
    };
  }, []);
...
exports.default = TestConnectorError;
