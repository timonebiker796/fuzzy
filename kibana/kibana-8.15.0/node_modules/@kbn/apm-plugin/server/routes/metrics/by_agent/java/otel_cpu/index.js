...
exports.getOTelSystemCPUChartDataForJava = getOTelSystemCPUChartDataForJava;
...
function getOTelSystemCPUChartDataForJava({
  environment,
  kuery,
  config,
  apmEventClient,
  ...
  return (0, _fetch_and_transform_metrics.fetchAndTransformMetrics)({
    ...
    aggs: {
      systemCPUAverage: {
        avg: {
          field: _apm.METRIC_OTEL_JVM_SYSTEM_CPU_PERCENT
        }
      },
      systemCPUMax: {
        max: {
      ...
      processCPUAverage: {
        avg: {
          field: _apm.METRIC_OTEL_JVM_PROCESS_CPU_PERCENT
        }
      },
      processCPUMax: {
        max: {
