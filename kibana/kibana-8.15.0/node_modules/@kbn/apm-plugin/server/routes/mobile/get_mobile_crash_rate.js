...
exports.getMobileCrashRate = getMobileCrashRate;
...
async function getMobileCrashTimeseries({
  ...
  const response = await apmEventClient.search('get_mobile_crash_rate', {
    ...
    body: {
      ...
      query: {
        bool: {
          filter: [...(0, _server.termQuery)(_apm.ERROR_TYPE, 'crash'), ...(0, _server.termQuery)(_apm.SERVICE_NAME, serviceName), ...(0, _server.rangeQuery)(startWithOffset, endWithOffset), ...(0, _environment_query.environmentQuery)(environment), ...(0, _server.kqlQuery)(kuery)]
        }
      },
      aggs: {
        timeseries: {
  ...
  return {
    timeseries,
    value: (_response$aggregation3 = response.aggregations) === null || _response$aggregation3 === void 0 ? void 0 : (_response$aggregation4 = _response$aggregation3.crashes) === null || _response$aggregation4 === void 0 ? void 0 : _response$aggregation4.value
  };
}
async function getMobileCrashRate({
  kuery,
  apmEventClient,
  serviceName,
  transactionName,
