...
exports.getMobileErrorGroupDetailedStatistics = getMobileErrorGroupDetailedStatistics;
exports.getMobileErrorGroupPeriods = getMobileErrorGroupPeriods;
...
async function getMobileErrorGroupDetailedStatistics({
  kuery,
  serviceName,
  apmEventClient,
  numBuckets,
...
async function getMobileErrorGroupPeriods({
  kuery,
  serviceName,
  apmEventClient,
  numBuckets,
  ...
  const previousPeriodPromise = offset ? getMobileErrorGroupDetailedStatistics({
    ...commonProps,
    start,
    end,
    offset
