...
exports.createEditConfig = exports.createDownloadServerRpm = exports.createDownloadServerOtherLinux = exports.createDownloadServerOsx = exports.createDownloadServerDeb = void 0;
exports.createStartServerUnix = createStartServerUnix;
exports.createStartServerUnixBinari = createStartServerUnixBinari;
...
function createStartServerUnixBinari() {
  const START_SERVER = createStartServer();
  return {
    title: START_SERVER.title,
    textPre: START_SERVER.textPre,
...
const createDownloadServerDeb = () => ({
  ...
  textPost: _i18n.i18n.translate('xpack.apm.tutorial.downloadServerTitle', {
    defaultMessage: 'Looking for the aarch64 packages? See the [Download page]({downloadPageLink}).',
    values: {
...
const createDownloadServerOtherLinux = () => ({
  title: createDownloadServerTitle(),
  commands: ['curl -L -O https://artifacts.elastic.co/downloads/apm-server/apm-server-{config.kibana.version}-linux-x86_64.tar.gz', 'tar xzvf apm-server-{config.kibana.version}-darwin-x86_64.tar.gz']
});
exports.createDownloadServerOtherLinux = createDownloadServerOtherLinux;
