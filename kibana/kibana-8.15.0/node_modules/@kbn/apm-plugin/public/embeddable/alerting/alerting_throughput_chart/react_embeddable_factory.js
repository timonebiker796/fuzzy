...
exports.getApmAlertingThroughputChartEmbeddableFactory = exports.APM_ALERTING_THROUGHPUT_CHART_EMBEDDABLE = void 0;
...
const APM_ALERTING_THROUGHPUT_CHART_EMBEDDABLE = exports.APM_ALERTING_THROUGHPUT_CHART_EMBEDDABLE = 'APM_ALERTING_THROUGHPUT_CHART_EMBEDDABLE';
const getApmAlertingThroughputChartEmbeddableFactory = deps => {
  const factory = {
      ...
      return {
        ...
        Component: () => {
          ...
          return /*#__PURE__*/_react.default.createElement(_embeddable_context.ApmEmbeddableContext, {
            ...
            rangeFrom: rangeFrom,
            rangeTo: rangeTo
          }, /*#__PURE__*/_react.default.createElement(_chart.APMAlertingThroughputChart, {
            rule: rule,
            alert: alert,
...
exports.getApmAlertingThroughputChartEmbeddableFactory = getApmAlertingThroughputChartEmbeddableFactory;