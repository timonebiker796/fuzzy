...
async function registerEmbeddables(deps) {
  const coreSetup = deps.coreSetup;
  ...
  const registerApmAlertingLatencyChartEmbeddable = async () => {
    ...
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('./alerting/alerting_latency_chart/react_embeddable_factory')));
  ...
  const registerApmAlertingThroughputChartEmbeddable = async () => {
    ...
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('./alerting/alerting_throughput_chart/react_embeddable_factory')));
    registerReactEmbeddableFactory(APM_ALERTING_THROUGHPUT_CHART_EMBEDDABLE, async () => {
      return getApmAlertingThroughputChartEmbeddableFactory({
        ...deps,
        coreStart,
        pluginsStart
      });
  ...
  const registerApmAlertingFailedTransactionsChartEmbeddable = async () => {
    ...
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('./alerting/alerting_failed_transactions_chart/react_embeddable_factory')));
