...
exports.createFlaskAgentInstructions = void 0;
...
const createFlaskAgentInstructions = commonOptions => {
  const {
    baseUrl,
    apmServerUrl,
    apiKeyDetails,
  ...
  return [{
    title: _i18n.i18n.translate('xpack.apm.onboarding.flask.install.title', {
      defaultMessage: 'Install the APM agent'
    }),
    children: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiMarkdownFormat, null, _i18n.i18n.translate('xpack.apm.onboarding.flask.install.textPre', {
    ...
    title: _i18n.i18n.translate('xpack.apm.onboarding.flask.configure.title', {
      defaultMessage: 'Configure the agent'
    }),
    children: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiMarkdownFormat, null, _i18n.i18n.translate('xpack.apm.onboarding.flask.configure.textPre', {
...
APM services are created programmatically based on the `SERVICE_NAME`.'
      ...
      variantId: _instruction_variants.INSTRUCTION_VARIANT.FLASK,
    ...
    }), /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, null), /*#__PURE__*/_react.default.createElement(_eui.EuiMarkdownFormat, null, _i18n.i18n.translate('xpack.apm.onboarding.flask.configure.textPost', {
