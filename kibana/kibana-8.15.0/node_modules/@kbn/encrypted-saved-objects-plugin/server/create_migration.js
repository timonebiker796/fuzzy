...
const getCreateMigration = (encryptedSavedObjectsService, instantiateServiceWithLegacyType) => opts => {
  ...
  return (encryptedDoc, context) => {
    ...
    const documentToMigrate = (0, _map_attributes.mapAttributes)(encryptedDoc, inputAttributes => {
      try {
    ...
    return (0, _map_attributes.mapAttributes)(migration(documentToMigrate, context), migratedAttributes => {
