...
const createSavedObjectsResultProvider = () => {
  return {
    ...
    find: ({
      ...
      return (0, _rxjs.combineLatest)([(0, _rxjs.from)(responsePromise), capabilities.pipe((0, _rxjs.first)())]).pipe((0, _rxjs.takeUntil)(aborted$), (0, _rxjs.map)(([res, cap]) => (0, _map_object_to_result.mapToResults)(res.saved_objects, typeRegistry, cap)));
    },
    getSearchableTypes: ({
      core
    }) => {
