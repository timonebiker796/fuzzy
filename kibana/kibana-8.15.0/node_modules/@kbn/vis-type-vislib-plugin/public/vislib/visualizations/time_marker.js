...
class TimeMarker {
  constructor(times, xScale, height) {
    ...
    this.times = times.length ? times.map(function (d) {
      return {
        time: _datemath.default.parse(d.time),
  ...
  render(selection) {
    ...
    selection.each(function () {
      _d.default.select(this).selectAll('time-marker').data(self.times).enter().append('line').attr('class', function (d) {
        return d.class;
