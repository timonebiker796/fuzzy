 ...
 */
const strings = {
  getDisplayName: () => _i18n.i18n.translate('expressionShape.renderer.progress.displayName', {
    defaultMessage: 'Progress'
  }),
  getHelpDescription: () => _i18n.i18n.translate('expressionShape.renderer.progress.helpDescription', {
    defaultMessage: 'Render a basic progress'
  })
};
const getProgressRenderer = (theme$ = _common.defaultTheme$) => () => ({
  name: 'progress',
  ...
  render: async (domNode, config, handlers) => {
    const {
      ProgressComponent
    } = await Promise.resolve().then(() => _interopRequireWildcard(require('../components/progress')));
    handlers.onDestroy(() => {
    ...
    }, /*#__PURE__*/_react.default.createElement(_i18nReact.I18nProvider, null, /*#__PURE__*/_react.default.createElement(ProgressComponent, (0, _extends2.default)({}, config, {
      parentNode: domNode,
...
const progressRendererFactory = core => getProgressRenderer(core.theme.theme$);
