...
const customElementSchema = exports.customElementSchema = {
  custom_elements: {
    count: {
      type: 'long',
      _meta: {
...
const customElementCollector = exports.customElementCollector = async function customElementCollector(getIndexForType, esClient) {
