...
const ext = name => _path.default.extname(name);
const base64 = name => _fs.default.readFileSync(_path.default.resolve(__dirname, 'assets', name), 'base64');
...
const embed = name => `data:${contentType(name)};base64,${base64(name)}`;
const pitch = exports.pitch = {
  ...
  template: {
    ...
    pages: [{
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-a30a06eb-2276-44b1-a62d-856e2116138c"} mode="cover"\n| render'
      }, {
        ...
        expression: 'shape "square" fill="#000000" border="rgba(255,255,255,0)" borderWidth=0 maintainAspect=false\n| render containerStyle={containerStyle opacity="0.7"}'
      }, {
        ...
        expression: 'image dataurl={asset "asset-23edd689-2d34-4bb8-a3eb-05420dd87b85"} mode="contain"\n| render'
      }],
      groups: []
    }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-048ed81e-84ae-4a48-9c30-641cf72b0376"} mode="cover"\n| render'
      }, {
        ...
        expression: 'shape "square" fill="#45bdb0" border="rgba(255,255,255,0)" borderWidth=0 maintainAspect=false\n| render'
      }, {
        ...
        expression: 'shape "square" fill="#444444" border="rgba(255,255,255,0)" borderWidth=0 maintainAspect=false\n| render'
      }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-aa91a324-8012-477e-a7e4-7c3cd7a6332f"} mode="contain"\n| render'
      }, {
        ...
        expression: 'image dataurl={asset "asset-0c6f377f-771e-432e-8e2e-15c3e9142ad6"} mode="contain"\n| render'
      }, {
        ...
        expression: 'image dataurl={asset "asset-9c2e5ab5-2dbe-43a8-bc84-e67f191fbcd8"} mode="contain"\n| render'
      }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-6fb8f925-0e1e-4108-8442-3dbf88d145e5"} mode="cover"\n| render'
      }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-d38c5025-eafc-4a35-a5fd-fb7b5bdc9efa"} mode="cover"\n| render'
      }, {
        ...
        expression: 'image dataurl={asset "asset-b22b6fa7-618c-4a59-82a1-ca921454da48"} mode="contain"\n| render'
      }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-7f2d5d96-3c85-49a0-94f3-e9b05de23cb6"} mode="cover"\n| render'
      }, {
      ...
      elements: [{
        ...
        expression: 'image dataurl={asset "asset-0791ed56-9a2e-4d0d-8d2d-a2f8c3c268ee"} mode="cover"\n| render'
      }, {
        ...
        expression: 'shape "square" fill="#222222" border="rgba(255,255,255,0)" borderWidth=0 maintainAspect=false\n| render'
      }, {
