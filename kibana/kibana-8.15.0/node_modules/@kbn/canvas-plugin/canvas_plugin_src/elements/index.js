...
var _metric_vis_legacy = require("./metric_vis_legacy");
...
const notExposedElementsSpecs = [_metric_vis.metricVis, _metric_vis_legacy.legacyMetricVis, _pie_vis.pieVis];
...
const initializeElementsSpec = (core, plugins) => {
  ...
  return [...(0, _elements.applyElementStrings)(notExposedElementsSpecs), ...specs];
};
