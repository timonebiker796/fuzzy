...
const timeFilterFactory = (core, _plugins) => {
  const {
    uiSettings
  } = core;
  ...
  return () => ({
    ...
    render: async (domNode, config, handlers) => {
      ...
      _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_reactKibanaContextRender.KibanaRenderContextProvider, core, /*#__PURE__*/_react.default.createElement(_components.TimeFilter, {
