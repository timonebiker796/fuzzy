...
const dropdownFilterFactory = (core, _plugins) => () => ({
  ...
  render(domNode, config, handlers) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_reactKibanaContextRender.KibanaRenderContextProvider, core, filter), domNode, () => handlers.done());
    handlers.onDestroy(() => {
