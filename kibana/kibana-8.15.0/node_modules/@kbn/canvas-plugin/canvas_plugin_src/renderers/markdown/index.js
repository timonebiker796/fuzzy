...
const getMarkdownRenderer = core => () => ({
  name: 'markdown',
  ...
  render(domNode, config, handlers) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_reactKibanaContextRender.KibanaRenderContextProvider, core, /*#__PURE__*/_react.default.createElement(_public.Markdown, {
...
const markdownFactory = (core, _plugins) => getMarkdownRenderer(core);
