...
const getTableRenderer = core => () => ({
  ...
  render(domNode, config, handlers) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_reactKibanaContextRender.KibanaRenderContextProvider, core, /*#__PURE__*/_react.default.createElement("div", {
      style: {
        ...font.spec,
        height: '100%'
      }
