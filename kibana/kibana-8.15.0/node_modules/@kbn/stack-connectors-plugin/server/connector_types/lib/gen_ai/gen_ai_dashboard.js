...
exports.getDashboardTitle = exports.getDashboard = void 0;
var _uuid = require("uuid");
var _constants = require("../../../../common/openai/constants");
var _constants2 = require("../../../../common/bedrock/constants");
var _constants3 = require("../../../../common/gemini/constants");
/*
...
const getDashboard = (genAIProvider, dashboardId) => {
  ...
  if (genAIProvider === 'OpenAI') {
    ...
    attributes = {
      provider: _constants3.GEMINI_TITLE,
      dashboardTitle: getDashboardTitle(_constants3.GEMINI_TITLE),
      actionTypeId: _constants3.GEMINI_CONNECTOR_ID
    };
  }
  const ids = {
