...
function getConnectorType() {
  return {
    ...
    selectMessage: _i18n.i18n.translate('xpack.stackConnectors.components.teams.selectMessageText', {
      defaultMessage: 'Send a message to a Microsoft Teams channel.'
    }),
    actionTypeTitle: _i18n.i18n.translate('xpack.stackConnectors.components.teams.connectorTypeTitle', {
      defaultMessage: 'Send a message to a Microsoft Teams channel.'
    }),
    ...
    actionConnectorFields: /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./teams_connectors')))),
    actionParamsFields: /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./teams_params'))))
  };
}