...
function getConnectorType() {
  return {
    ...
    actionTypeTitle: _constants.CROWDSTRIKE_TITLE,
    iconClass: /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./logo')))),
    isExperimental: true,
    selectMessage: _i18n.i18n.translate('xpack.stackConnectors.security.crowdstrike.config.selectMessageText', {
    ...
    validateParams: async actionParams => {
      ...
      } else if (!Object.values(_constants.SUB_ACTION).includes(subAction)) {
    ...
    actionConnectorFields: /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./crowdstrike_connector')))),
    actionParamsFields: /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./crowdstrike_params_empty'))))
