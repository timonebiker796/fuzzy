 ...
 * 2.0.
 */
const renderApp = async (core, services, element) => {
  const {
    InferenceEndpointsRouter
  } = await Promise.resolve().then(() => _interopRequireWildcard(require('./inference_endpoints_router')));
  ...
  }, /*#__PURE__*/_react.default.createElement(InferenceEndpointsRouter, null))))), element);
