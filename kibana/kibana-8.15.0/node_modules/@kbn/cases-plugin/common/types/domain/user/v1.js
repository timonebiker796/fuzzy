...
const UserRt = exports.UserRt = rt.intersection([UserWithoutProfileUidRt, rt.exact(rt.partial({
  profile_uid: rt.string
}))]);
const UserWithProfileInfoRt = exports.UserWithProfileInfoRt = rt.intersection([rt.strict({
...
const UsersRt = exports.UsersRt = rt.array(UserRt);
const CaseUserProfileRt = exports.CaseUserProfileRt = rt.strict({
  uid: rt.string
});
/**
 * Assignees
 */
const CaseAssigneesRt = exports.CaseAssigneesRt = rt.array(CaseUserProfileRt);