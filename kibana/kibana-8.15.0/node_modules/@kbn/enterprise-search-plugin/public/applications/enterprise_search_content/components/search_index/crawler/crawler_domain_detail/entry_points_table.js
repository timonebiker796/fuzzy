...
const EntryPointsTable = ({
  ...
  const columns = [{
    ...
    name: _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.urlTableHead', {
      defaultMessage: 'URL'
    }),
    field
  }];
  const entryPointsRoute = `/internal/enterprise_search/indices/${indexName}/crawler/domains/${domain.id}/entry_points`;
  const getEntryPointRoute = entryPoint => `/internal/enterprise_search/indices/${indexName}/crawler/domains/${domain.id}/entry_points/${entryPoint.id}`;
  return /*#__PURE__*/_react.default.createElement(_generic_endpoint_inline_editable_table.GenericEndpointInlineEditableTable, {
    addButtonText: _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.addButtonLabel', {
      defaultMessage: 'Add entry point'
    }),
    columns: columns,
    description: /*#__PURE__*/_react.default.createElement("p", null, _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.description', {
      ...
      target: "_blank",
      external: true
    }, _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.learnMoreLinkText', {
      defaultMessage: 'Learn more about entry points.'
    }))),
    instanceId: "EntryPointsTable",
    items: items,
    lastItemWarning: _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.lastItemMessage', {
    ...
    noItemsMessage: editNewItem => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, null), /*#__PURE__*/_react.default.createElement(_eui.EuiTitle, {
      size: "m"
    }, /*#__PURE__*/_react.default.createElement("h4", null, _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.emptyMessageTitle', {
      ...
      values: {
        link: /*#__PURE__*/_react.default.createElement(_eui.EuiLink, {
          onClick: editNewItem
        }, _i18n.i18n.translate('xpack.enterpriseSearch.crawler.entryPointsTable.emptyMessageLinkText', {
