...
var _crawler_extraction_rules = require("../enterprise_search/crawler/crawler_extraction_rules");
...
const registerAppSearchRoutes = dependencies => {
  ...
  (0, _crawler_extraction_rules.registerCrawlerExtractionRulesRoutes)(dependencies);
