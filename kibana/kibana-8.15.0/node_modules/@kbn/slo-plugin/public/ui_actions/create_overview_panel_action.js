...
exports.createOverviewPanelAction = createOverviewPanelAction;
 ...
 * 2.0.
 */
function createOverviewPanelAction(getStartServices) {
  return {
    id: _constants.ADD_SLO_OVERVIEW_ACTION_ID,
    ...
    execute: async ({
      ...
      try {
        ...
        } = await Promise.resolve().then(() => _interopRequireWildcard(require('../embeddable/slo/overview/slo_overview_open_configuration')));
        const initialState = await openSloConfiguration(coreStart, deps);
        embeddable.addNewPanel({
          panelType: _constants.SLO_OVERVIEW_EMBEDDABLE_ID,
          initialState
        }, true);
      } catch (e) {
    ...
    getDisplayName: () => _i18n.i18n.translate('xpack.slo.sloEmbeddable.ariaLabel', {
