...
exports.createAddErrorBudgetPanelAction = createAddErrorBudgetPanelAction;
 ...
 * 2.0.
 */
function createAddErrorBudgetPanelAction(getStartServices) {
  return {
    id: _constants.ADD_SLO_ERROR_BUDGET_ACTION_ID,
    ...
    execute: async ({
      ...
      try {
        ...
        } = await Promise.resolve().then(() => _interopRequireWildcard(require('../embeddable/slo/error_budget/error_budget_open_configuration')));
        const initialState = await openSloConfiguration(coreStart, deps);
        embeddable.addNewPanel({
          panelType: _constants.SLO_ERROR_BUDGET_ID,
          initialState
        }, true);
      } catch (e) {
    ...
    getDisplayName: () => _i18n.i18n.translate('xpack.slo.errorBudgetEmbeddable.ariaLabel', {
