...
const getSLOSummaryPipelineTemplate = (slo, spaceId, basePath) => {
  var _basePath$publicBaseU;
  ...
  return {
    ...
    // >= 8.14:
    {
      ...
      set: {
        field: 'kibanaUrl',
        value: (_basePath$publicBaseU = basePath.publicBaseUrl) !== null && _basePath$publicBaseU !== void 0 ? _basePath$publicBaseU : '',
        ignore_failure: true
      }
    },
    // >= 8.15:
    {
      script: {
        ...
        lang: 'painless',
        params: {
          isTimeslice: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod),
          totalSlicesInRange: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod) ? Math.floor(5 / slo.objective.timesliceWindow.asMinutes()) : 0
        },
      ...
      script: {
        ...
        params: {
          isTimeslice: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod),
          totalSlicesInRange: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod) ? Math.floor(60 / slo.objective.timesliceWindow.asMinutes()) : 0
        },
      ...
      script: {
        ...
        params: {
          isTimeslice: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod),
          totalSlicesInRange: _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod) ? Math.floor(1440 / slo.objective.timesliceWindow.asMinutes()) : 0
        },
...
function getBurnRateSource(burnRateKey) {
