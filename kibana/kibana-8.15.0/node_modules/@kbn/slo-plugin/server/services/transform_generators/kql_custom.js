...
class KQLCustomTransformGenerator extends _.TransformGenerator {
  ...
  async buildSource(slo, indicator, dataViewService) {
    ...
    return {
      ...
      query: {
        bool: {
          filter: [(0, _common.getFilterRange)(slo, indicator.params.timestampField), (0, _.getElasticsearchQueryOrThrow)(indicator.params.filter)]
        }
      }
    };
  }
  ...
  buildAggregations(slo, indicator) {
    const numerator = (0, _.getElasticsearchQueryOrThrow)(indicator.params.good);
    const denominator = (0, _.getElasticsearchQueryOrThrow)(indicator.params.total);
    return {
      'slo.numerator': {
        filter: numerator
      },
