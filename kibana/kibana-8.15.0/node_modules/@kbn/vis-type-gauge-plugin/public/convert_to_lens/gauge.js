...
var _gauge = require("./configurations/gauge");
/*
...
const convertToLens = async (vis, timefilter) => {
  ...
  return {
    ...
    configuration: (0, _gauge.getConfiguration)(layerId, vis.params, getPalette(vis.params.gauge, percentageModeConfig, true), {
      metricAccessor,
