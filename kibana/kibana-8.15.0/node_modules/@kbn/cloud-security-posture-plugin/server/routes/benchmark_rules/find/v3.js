...
const findBenchmarkRuleHandler = async (soClient, options) => {
  ...
  const sectionFilter = typeof (options === null || options === void 0 ? void 0 : options.section) === 'string' ? [options === null || options === void 0 ? void 0 : options.section] : options === null || options === void 0 ? void 0 : options.section;
  const ruleNumberFilter = typeof (options === null || options === void 0 ? void 0 : options.ruleNumber) === 'string' ? [options === null || options === void 0 ? void 0 : options.ruleNumber] : options === null || options === void 0 ? void 0 : options.ruleNumber;
  ...
  const cspCspBenchmarkRulesSo = await soClient.find({
    ...
    filter: (0, _helpers.getBenchmarkFilterQueryV2)(benchmarkId, options.benchmarkVersion || '', {
  ...
  const sortedCspBenchmarkRules = (0, _utils.getSortedCspBenchmarkRulesTemplates)(cspBenchmarkRules, options.sortOrder);
  return {
    items: options.sortField === 'metadata.benchmark.rule_number' ? sortedCspBenchmarkRules : cspBenchmarkRules,
