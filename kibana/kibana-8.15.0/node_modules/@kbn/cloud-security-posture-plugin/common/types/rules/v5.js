...
exports.findCspBenchmarkRuleRequestSchema = void 0;
...
const findCspBenchmarkRuleRequestSchema = exports.findCspBenchmarkRuleRequestSchema = _configSchema.schema.object({
   ...
   * rule section
   */
  section: _configSchema.schema.maybe(_configSchema.schema.oneOf([_configSchema.schema.string(), _configSchema.schema.arrayOf(_configSchema.schema.string(), {
    minSize: 1
  })])),
  ruleNumber: _configSchema.schema.maybe(_configSchema.schema.oneOf([_configSchema.schema.string(), _configSchema.schema.arrayOf(_configSchema.schema.string(), {
    minSize: 1
  })]))
});