...
const DATA_TELEMETRY_ID = exports.DATA_TELEMETRY_ID = 'data';
const DATA_KNOWN_TYPES = exports.DATA_KNOWN_TYPES = ['logs', 'traces', 'metrics'];
...
const DATA_DATASETS_INDEX_PATTERNS = exports.DATA_DATASETS_INDEX_PATTERNS = [
...
// Observability - Elastic
{
  ...
  pattern: '*metricbeat*',
  patternName: 'generic-metricbeat'
}, {
  pattern: 'apm-*',
  patternName: 'apm',
  shipper: 'apm'
  ...
  pattern: '*functionbeat*',
  patternName: 'generic-functionbeat'
}, {
  pattern: 'heartbeat-*',
...
const DATA_DATASETS_INDEX_PATTERNS_UNIQUE = exports.DATA_DATASETS_INDEX_PATTERNS_UNIQUE = DATA_DATASETS_INDEX_PATTERNS.filter((entry, index, array) => !array.slice(0, index).find(({
  pattern
