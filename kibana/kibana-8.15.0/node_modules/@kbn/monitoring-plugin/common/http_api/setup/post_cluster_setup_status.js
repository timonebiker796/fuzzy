...
const postClusterSetupStatusRequestParamsRT = exports.postClusterSetupStatusRequestParamsRT = rt.partial({
  clusterUuid: _shared.clusterUuidRT
});
const postClusterSetupStatusRequestQueryRT = exports.postClusterSetupStatusRequestQueryRT = rt.partial({
...
const postClusterSetupStatusRequestPayloadRT = exports.postClusterSetupStatusRequestPayloadRT = rt.partial({
  ccs: _shared.ccsRT,
  timeRange: _shared.timeRangeRT
});
const postClusterSetupStatusResponsePayloadRT = exports.postClusterSetupStatusResponsePayloadRT = rt.type({
