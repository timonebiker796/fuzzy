...
exports.createMemoryUsageAlertType = createMemoryUsageAlertType;
...
function createMemoryUsageAlertType(config) {
  return {
    id: _constants.RULE_MEMORY_USAGE,
    description: _constants.RULE_DETAILS[_constants.RULE_MEMORY_USAGE].description,
    iconClass: 'bell',
    ...
    ruleParamsExpression: props => /*#__PURE__*/_react.default.createElement(_lazy_expression.LazyExpression, (0, _extends2.default)({}, props, {
      config: config,
      paramDetails: _constants.RULE_DETAILS[_constants.RULE_MEMORY_USAGE].paramDetails
    })),
