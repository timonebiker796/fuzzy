...
function formatMsg(err, source = '') {
  ...
  if (typeof err === 'string') {
    ...
    if (err.status === -1) {
      ...
      message += _i18n.i18n.translate('xpack.monitoring.formatMsg.toaster.unavailableServerErrorMessage', {
      ...
      message += _i18n.i18n.translate('xpack.monitoring.formatMsg.toaster.errorStatusMessage', {
