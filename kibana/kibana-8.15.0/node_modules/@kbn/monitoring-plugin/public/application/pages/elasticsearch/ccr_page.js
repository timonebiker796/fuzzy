...
exports.ElasticsearchCcrPage = void 0;
...
var _ccr = require("../../../components/elasticsearch/ccr");
...
const ElasticsearchCcrPage = ({
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.elasticsearch.ccr.title', {
    defaultMessage: 'Elasticsearch - Ccr'
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.elasticsearch.ccr.pageTitle', {
    defaultMessage: 'Elasticsearch Ccr'
  });
  ...
  return /*#__PURE__*/_react.default.createElement(_elasticsearch_template.ElasticsearchTemplate, {
    ...
    }, flyoutComponent, /*#__PURE__*/_react.default.createElement(_ccr.Ccr, {
      data: data,
      alerts: alerts
    }), bottomBarComponent)
  }));
};
exports.ElasticsearchCcrPage = ElasticsearchCcrPage;