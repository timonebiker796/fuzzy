        ...
        filter: {
          bool: {
            must: [{
              ...
              terms: {
                [errorQueryIsDataStream ? 'service.type' : 'event.module']: Object.values(products)
              }
            }, {
              range: {
                '@timestamp': {
...
exports.errorsQuery = errorsQuery;
...
const errorsAggregation = errorQueryIsDataStream => ({
  terms: {
