...
async function getKibanas(req, {
  ...
  return instances.map(hit => {
    var _hit$_source$kibana, _hit$_source$Timesta, _mbStats$concurrent_c, _mbStats$process$memo, _mbStats$process, _mbStats$process$memo2, _mbStats$process$memo3, _legacyStats$process, _legacyStats$process$, _mbStats$os$load$1m, _mbStats$os, _mbStats$os$load, _legacyStats$os, _legacyStats$os$load, _mbStats$response_tim, _mbStats$response_tim2, _mbStats$response_tim3, _legacyStats$response, _mbStats$response_tim4, _mbStats$response_tim5, _mbStats$response_tim6, _legacyStats$response2, _mbStats$request$tota, _mbStats$request, _legacyStats$requests;
    ...
    const lastSeenTimestamp = (_hit$_source$Timesta = hit._source['@timestamp']) !== null && _hit$_source$Timesta !== void 0 ? _hit$_source$Timesta : hit._source.timestamp;
    const kibana = {
