...
function delayOnClaimConflicts(maxWorkersConfiguration$, pollIntervalConfiguration$, taskLifecycleEvents$, claimClashesPercentageThreshold, runningAverageWindowSize) {
  ...
  (0, _rxjs.merge)((0, _rxjs.of)(0), (0, _rxjs.combineLatest)([maxWorkersConfiguration$, pollIntervalConfiguration$, taskLifecycleEvents$.pipe((0, _rxjs.map)(taskEvent => {
  ...
  }), (0, _rxjs.filter)(claimClashes => (0, _Option.isSome)(claimClashes)), (0, _rxjs.map)(claimClashes => claimClashes.value))]).pipe((0, _rxjs.map)(([maxWorkers, pollInterval, latestClaimConflicts]) => {
    ...
    return _Option.none;
  }), (0, _rxjs.filter)(pollInterval => (0, _Option.isSome)(pollInterval)), (0, _rxjs.map)(maybePollInterval => {
