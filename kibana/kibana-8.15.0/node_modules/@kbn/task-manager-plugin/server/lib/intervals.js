 ...
 * 2.0.
 */
let IntervalCadence = exports.IntervalCadence = /*#__PURE__*/function (IntervalCadence) {
 ...
 */
const parseIntervalAsSecond = exports.parseIntervalAsSecond = (0, _lodash.memoize)(interval => {
  return Math.round(parseIntervalAsMillisecond(interval) / 1000);
});
const parseIntervalAsMillisecond = exports.parseIntervalAsMillisecond = (0, _lodash.memoize)(interval => {
  const numericAsStr = interval.slice(0, -1);
  const numeric = parseInt(numericAsStr, 10);
  const cadence = interval.slice(-1);
