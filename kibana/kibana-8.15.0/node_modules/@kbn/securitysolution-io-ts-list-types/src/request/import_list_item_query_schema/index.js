...
var _refresh = require("../../common/refresh");
...
const importListItemQuerySchema = exports.importListItemQuerySchema = t.exact(t.partial({
  deserializer: _deserializer.deserializer,
  list_id: _list_id.list_id,
  serializer: _serializer.serializer,
  type: _type.type,
  refresh: _refresh.refreshWithWaitFor
}));