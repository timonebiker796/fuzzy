...
const bulkErrorErrorSchema = exports.bulkErrorErrorSchema = t.exact(t.type({
  status_code: t.number,
  message: t.string
}));
const bulkErrorSchema = exports.bulkErrorSchema = t.intersection([t.exact(t.type({
...
const importExceptionsResponseSchema = exports.importExceptionsResponseSchema = t.exact(t.type({
