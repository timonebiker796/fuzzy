...
const list = exports.list = t.exact(t.type({
...
const listArray = exports.listArray = t.array(list);
const listArrayOrUndefined = exports.listArrayOrUndefined = t.union([listArray, t.undefined]);