...
class CoreUiSettingsRouteHandlerContext {
  constructor(uiSettingsStart, savedObjectsRouterHandlerContext) {
    ...
    _classPrivateFieldInitSpec(this, _globalClient, void 0);
  ...
  get client() {
    if (_classPrivateFieldGet(_client, this) == null) {
      _classPrivateFieldSet(_client, this, this.uiSettingsStart.asScopedToClient(this.savedObjectsRouterHandlerContext.client));
    }
    return _classPrivateFieldGet(_client, this);
  }
  get globalClient() {
    if (_classPrivateFieldGet(_globalClient, this) == null) {
      _classPrivateFieldSet(_globalClient, this, this.uiSettingsStart.globalAsScopedToClient(this.savedObjectsRouterHandlerContext.client));
    }
    return _classPrivateFieldGet(_globalClient, this);
  }
}
