...
exports.bulkActionConversationsRoute = void 0;
...
var _helpers = require("../../ai_assistant_data_clients/conversations/helpers");
var _create_conversation = require("../../ai_assistant_data_clients/conversations/create_conversation");
var _transforms = require("../../ai_assistant_data_clients/conversations/transforms");
var _update_conversation = require("../../ai_assistant_data_clients/conversations/update_conversation");
...
const bulkActionConversationsRoute = (router, logger) => {
  router.versioned.post({
    access: 'internal',
    path: _elasticAssistantCommon.ELASTIC_AI_ASSISTANT_CONVERSATIONS_URL_BULK_ACTION,
    options: {
    ...
    validate: {
      request: {
        body: (0, _common.buildRouteValidationWithZod)(_elasticAssistantCommon.PerformBulkActionRequestBody)
      }
    }
    ...
    if (operationsCount > _constants.CONVERSATIONS_TABLE_MAX_PAGE_SIZE) {
      return assistantResponse.error({
        body: `More than ${_constants.CONVERSATIONS_TABLE_MAX_PAGE_SIZE} ids sent for bulk edit action.`,
        statusCode: 400
      });
    }
    ...
    try {
      ...
      if (body.create && body.create.length > 0) {
        const userFilter = authenticatedUser !== null && authenticatedUser !== void 0 && authenticatedUser.username ? `name: "${authenticatedUser === null || authenticatedUser === void 0 ? void 0 : authenticatedUser.username}"` : `id: "${authenticatedUser === null || authenticatedUser === void 0 ? void 0 : authenticatedUser.profile_uid}"`;
        const result = await (dataClient === null || dataClient === void 0 ? void 0 : dataClient.findDocuments({
          ...
          .map(c => `title:${JSON.stringify(c.title)}`).join(' OR ')})`,
          fields: ['title']
        }));
        if ((result === null || result === void 0 ? void 0 : result.data) != null && result.total > 0) {
          return assistantResponse.error({
            statusCode: 409,
            body: `conversations titles: "${(0, _transforms.transformESSearchToConversations)(result.data).map(c => c.title).join(',')}" already exists`
          });
        }
      }
      ...
      const {
        ...
        documentsToCreate: (_body$create2 = body.create) === null || _body$create2 === void 0 ? void 0 : _body$create2.map(c => (0, _create_conversation.transformToCreateScheme)(changedAt, spaceId, authenticatedUser, c)),
        documentsToDelete: (_body$delete2 = body.delete) === null || _body$delete2 === void 0 ? void 0 : _body$delete2.ids,
        documentsToUpdate: (_body$update2 = body.update) === null || _body$update2 === void 0 ? void 0 : _body$update2.map(c => (0, _update_conversation.transformToUpdateScheme)(changedAt, c)),
        authenticatedUser,
      ...
      return buildBulkResponse(response, {
        updated: docsUpdated ? (0, _transforms.transformESToConversations)(docsUpdated) : [],
        created: created !== null && created !== void 0 && created.data ? (0, _transforms.transformESSearchToConversations)(created === null || created === void 0 ? void 0 : created.data) : [],
...
exports.bulkActionConversationsRoute = bulkActionConversationsRoute;