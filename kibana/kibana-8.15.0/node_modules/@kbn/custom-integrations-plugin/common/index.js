 ...
 */
const PLUGIN_ID = exports.PLUGIN_ID = 'customIntegrations';
const PLUGIN_NAME = exports.PLUGIN_NAME = 'customIntegrations';

/**
 * A map of category names and their corresponding titles.
 */
// TODO: consider i18n
const INTEGRATION_CATEGORY_DISPLAY = exports.INTEGRATION_CATEGORY_DISPLAY = {
  ...
  cloudsecurity_cdr: {
    title: 'Cloud Security/CDR',
    parent_id: 'security'
  },
  elasticsearch_sdk: {
    title: 'Elasticsearch SDK',
    parent_id: undefined
  },
  elastic_stack: {
    title: 'Elastic Stack',
...
const FEATURED_INTEGRATIONS_BY_CATEGORY = exports.FEATURED_INTEGRATIONS_BY_CATEGORY = {
...
const category = exports.category = Object.keys(INTEGRATION_CATEGORY_DISPLAY);
 ...
 */
// TODO: consider i18n
const SHIPPER_DISPLAY = exports.SHIPPER_DISPLAY = {
  beats: 'Beats',
...
// This `as` is necessary, as Object.keys cannot be strongly typed.
// see: https://github.com/Microsoft/TypeScript/issues/12870
const shipper = exports.shipper = Object.keys(SHIPPER_DISPLAY);
...
const ROUTES_APPEND_CUSTOM_INTEGRATIONS = exports.ROUTES_APPEND_CUSTOM_INTEGRATIONS = `/internal/${PLUGIN_ID}/appendCustomIntegrations`;
const ROUTES_REPLACEMENT_CUSTOM_INTEGRATIONS = exports.ROUTES_REPLACEMENT_CUSTOM_INTEGRATIONS = `/internal/${PLUGIN_ID}/replacementCustomIntegrations`;