...
var _queries = require("../../components/app/rum_dashboard/local_uifilters/queries");
/*
...
function getEsFilter(uiFilters, exclude) {
  ...
  return [...mappedFilters, ...(exclude ? [] : (0, _queries.environmentQuery)(uiFilters.environment || _environment_filter_values.ENVIRONMENT_ALL.value))];
}