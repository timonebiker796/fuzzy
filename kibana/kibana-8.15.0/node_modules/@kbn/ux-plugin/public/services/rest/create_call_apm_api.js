...
function createCallApmApi(core) {
  exports.callApmApi = callApmApi = (endpoint, options) => {
    const {
      params
    } = options;
    const {
      method,
      pathname
    } = (0, _serverRouteRepository.formatRequest)(endpoint, params === null || params === void 0 ? void 0 : params.path);
    return (0, _call_api.callApi)(core, {
      ...options,
      method,
      pathname,
