 ...
 * 2.0.
 */
const VectorTileInspectorView = exports.VectorTileInspectorView = {
  ...
  component: props => {
    const Component = (0, _sharedUxUtility.dynamic)(async () => {
      const {
        VectorTileInspector
      } = await Promise.resolve().then(() => _interopRequireWildcard(require('./components/vector_tile_inspector')));
      return {
