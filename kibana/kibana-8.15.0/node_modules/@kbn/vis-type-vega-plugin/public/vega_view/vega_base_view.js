...
class VegaBaseView {
  ...
  updateVegaSize(view, dimensions) {
    ...
    const width = Math.floor(Math.max(0, (_dimensions$width = dimensions === null || dimensions === void 0 ? void 0 : dimensions.width) !== null && _dimensions$width !== void 0 ? _dimensions$width : this._container.getBoundingClientRect().width));
    const height = Math.floor(Math.max(0, (_dimensions$height = dimensions === null || dimensions === void 0 ? void 0 : dimensions.height) !== null && _dimensions$height !== void 0 ? _dimensions$height : this._container.getBoundingClientRect().height));
