...
const RuleExecutionStatus = exports.RuleExecutionStatus = _zod.z.enum(['going to run', 'running', 'partial failure', 'failed', 'succeeded']);
const RuleExecutionStatusEnum = exports.RuleExecutionStatusEnum = RuleExecutionStatus.enum;
const RuleExecutionStatusOrder = exports.RuleExecutionStatusOrder = _zod.z.number().int();