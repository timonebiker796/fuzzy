...
const esQuerySchema = exports.esQuerySchema = _zod.z.union([esRangeQuerySchema, esQueryStringQuerySchema, esMatchQuerySchema, esTermQuerySchema, esBoolQuerySchema, jsonObjectSchema]);
const filterQuery = exports.filterQuery = _zod.z.union([_zod.z.string(), _zod.z.any()]).optional();