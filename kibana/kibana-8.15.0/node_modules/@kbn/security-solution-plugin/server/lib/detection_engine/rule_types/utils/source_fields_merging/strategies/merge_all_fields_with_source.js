...
const hasEarlyReturnConditions = ({
  ...
  const valueInMergedDocument = (0, _fp.get)(fieldsKey, merged);
  return fieldsValue.length === 0 || valueInMergedDocument === undefined && !(0, _is_path_valid.isPathValid)(fieldsKey, merged) || (0, _is_objectlike_or_array_of_objectlikes.isObjectLikeOrArrayOfObjectLikes)(valueInMergedDocument) && !(0, _is_nested_object.isNestedObject)(fieldsValue) && !(0, _is_type_object.isTypeObject)(fieldsValue);
};