...
const UPDATE_TIMELINE_ERROR_MESSAGE = exports.UPDATE_TIMELINE_ERROR_MESSAGE = 'You cannot create new timelines with PATCH. Use POST instead.';
const UPDATE_TEMPLATE_TIMELINE_ERROR_MESSAGE = exports.UPDATE_TEMPLATE_TIMELINE_ERROR_MESSAGE = 'You cannot create new Timeline templates with PATCH. Use POST instead (templateTimelineId does not exist).';
const NO_MATCH_VERSION_ERROR_MESSAGE = exports.NO_MATCH_VERSION_ERROR_MESSAGE = 'Timeline version conflict. The provided timelineVersion does not match the current timeline.';
const NO_MATCH_TEMPLATE_VERSION_ERROR_MESSAGE = exports.NO_MATCH_TEMPLATE_VERSION_ERROR_MESSAGE = 'Timeline template version conflict. The provided templateTimelineVersion does not match the current template.';
const NO_MATCH_ID_ERROR_MESSAGE = exports.NO_MATCH_ID_ERROR_MESSAGE = 'There are no Timeline templates that match the provided templateTimelineId.';
const TEMPLATE_TIMELINE_VERSION_CONFLICT_MESSAGE = exports.TEMPLATE_TIMELINE_VERSION_CONFLICT_MESSAGE = 'To update existing Timeline templates, you must increment the templateTimelineVersion value.';
const CREATE_TIMELINE_ERROR_MESSAGE = exports.CREATE_TIMELINE_ERROR_MESSAGE = 'You cannot update timelines with POST. Use PATCH instead.';
const CREATE_TEMPLATE_TIMELINE_ERROR_MESSAGE = exports.CREATE_TEMPLATE_TIMELINE_ERROR_MESSAGE = 'You cannot update Timeline templates with POST. Use PATCH instead.';
const EMPTY_TITLE_ERROR_MESSAGE = exports.EMPTY_TITLE_ERROR_MESSAGE = 'The title field cannot be empty.';
const UPDATE_STATUS_ERROR_MESSAGE = exports.UPDATE_STATUS_ERROR_MESSAGE = 'You are not allowed to set the status field value to immutable.';
const CREATE_TEMPLATE_TIMELINE_WITHOUT_VERSION_ERROR_MESSAGE = exports.CREATE_TEMPLATE_TIMELINE_WITHOUT_VERSION_ERROR_MESSAGE = 'You must provide a valid templateTimelineVersion value. Use 1 for new Timeline templates.';
const CREATE_WITH_INVALID_STATUS_ERROR_MESSAGE = exports.CREATE_WITH_INVALID_STATUS_ERROR_MESSAGE = 'You are not allowed to set the status field value to draft.';
const NOT_ALLOW_UPDATE_STATUS_ERROR_MESSAGE = exports.NOT_ALLOW_UPDATE_STATUS_ERROR_MESSAGE = 'You are not allowed to set the status field.';
const NOT_ALLOW_UPDATE_TIMELINE_TYPE_ERROR_MESSAGE = exports.NOT_ALLOW_UPDATE_TIMELINE_TYPE_ERROR_MESSAGE = 'You cannot convert a Timeline template to a timeline, or a timeline to a Timeline template.';
const UPDAT_TIMELINE_VIA_IMPORT_NOT_ALLOWED_ERROR_MESSAGE = exports.UPDAT_TIMELINE_VIA_IMPORT_NOT_ALLOWED_ERROR_MESSAGE = 'You cannot update a timeline via imports. Use the UI to modify existing timelines.';
const DEFAULT_ERROR = exports.DEFAULT_ERROR = `Something has gone wrong. We didn't handle something properly. To help us fix this, please upload your file to https://discuss.elastic.co/c/security/siem.`;
