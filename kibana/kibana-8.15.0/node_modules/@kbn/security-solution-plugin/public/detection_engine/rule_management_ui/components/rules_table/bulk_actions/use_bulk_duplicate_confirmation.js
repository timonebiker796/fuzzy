...
exports.useBulkDuplicateExceptionsConfirmation = void 0;
 ...
 */
const useBulkDuplicateExceptionsConfirmation = () => {
  const [isBulkDuplicateConfirmationVisible, showModal, hideModal] = (0, _use_bool_state.useBoolState)();
  const confirmationPromiseRef = (0, _react.useRef)();
  const onConfirm = (0, _react.useCallback)(value => {
    var _confirmationPromiseR;
    (_confirmationPromiseR = confirmationPromiseRef.current) === null || _confirmationPromiseR === void 0 ? void 0 : _confirmationPromiseR.call(confirmationPromiseRef, value);
  }, []);
  ...
  const showBulkDuplicateConfirmation = (0, _react.useCallback)(async () => {
...
exports.useBulkDuplicateExceptionsConfirmation = useBulkDuplicateExceptionsConfirmation;