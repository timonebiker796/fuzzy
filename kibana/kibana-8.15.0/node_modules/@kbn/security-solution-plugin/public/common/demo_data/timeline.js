...
exports.demoTimelineData = void 0;
/*
...
const demoTimelineData = exports.demoTimelineData = [{
  _id: '1',
  data: [{
    field: '@timestamp',
  ...
  data: [{
    ...
    field: 'source.ip',
    value: ['192.168.26.101']
  }, {
    field: 'destination.ip',
    value: ['192.168.238.205']
  }],
  ecs: {
    _id: '14',
  ...
  data: [{
    ...
    field: 'process.args',
    value: ['gpgconf', '--list-dirs', 'agent-socket']
  }],
  ecs: {
    _id: '20',
