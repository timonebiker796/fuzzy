...
const DashboardButtonComponent = () => {
  ...
  const onClick = (0, _react.useCallback)(() => {
    onStepLinkClicked({
      originStepId: _types.ViewDashboardSteps.analyzeData,
      stepLinkId: _securitySolutionNavigation.SecurityPageName.dashboards
    });
    toggleTaskCompleteStatus({
...
const DashboardButton = exports.DashboardButton = /*#__PURE__*/_react.default.memo(DashboardButtonComponent);