...
exports.data = exports.columns = exports.browserFields = void 0;
/*
...
const browserFields = exports.browserFields = {
  host: {
    fields: {
      'host.name': {
        category: 'host',
        ...
        aggregatable: true,
        format: 'string',
        indexes: ['apm-*-transaction*', 'traces-apm*', 'auditbeat-*', 'endgame-*', 'filebeat-*', 'logs-*', 'packetbeat-*', 'winlogbeat-*']
      }
    }
  }
};
...
const data = exports.data = [[{
  ...
  value: ['apm-*-transaction*', 'auditbeat-*', 'endgame-*', 'filebeat-*', 'logs-*', 'packetbeat-*', 'traces-apm*', 'winlogbeat-*', '-*elastic-cloud-logs-*']
}, {
  ...
  value: ['4z_L1oMBiIcG4Y9J2nxd', '75e2a3903daac549c05eb3aebe90b3ef6d1921b74c4870ee518643a46f778a31']
}, {
  ...
  field: 'signal.reason',
  value: ['network event with process traefik, source 35.226.77.71:56296, destination 10.200.0.46:9200, by traefik on bastion00.siem.estc.dev created low alert Custom Rule.']
}, {
  ...
  value: ['http://localhost:5601/app/security/alerts/redirect/7d3194c7158fb9edb10541ccdd81f8c2b9c9d3c50b82c14457c959a2fcbcb22a?index=.alerts-security.alerts-default&timestamp=2023-04-25T09:03:15.516Z']
}, {
  ...
  value: ['MmVhNGIzNjMtNmEzZi00NDllLTlkNGUtYzczY2NmMjhmNjkzLTY1Mi0xNjY0ODA2NTI4Ljc4NTg5NTAw', 'MmVhNGIzNjMtNmEzZi00NDllLTlkNGUtYzczY2NmMjhmNjkzLTUzNi0xNjY0ODA2NTI3LjEwNDI2NTQwMA==']
}, {
  field: 'kibana.alert.original_event.module',
  value: ['endpoint']
}, {
  ...
  field: 'process.entity_id',
  value: ['MmVhNGIzNjMtNmEzZi00NDllLTlkNGUtYzczY2NmMjhmNjkzLTE3MDQtMTY2NDgwNjcwNi4yODUzODk4MDA=']
}, {
  field: 'host.ip',
  ...
  field: 'kibana.alert.ancestors.id',
  value: ['cyjM1oMBw7Pvz6uQMxM4', 'd46d9fecad3a03741575f552c994ec9c9e5d1089557d49d125255bcd8d863a99']
}, {
  field: 'kibana.alert.rule.building_block_type',
  value: ['default']
}, {
  ...
  field: 'kibana.alert.url',
  value: ['http://localhost:5601/app/security/alerts/redirect/1066d5c3675d7eef4b9e84af64e795be39d1896ec791049eb87a39eb9675a2aa?index=.alerts-security.alerts-default&timestamp=2023-04-25T09:03:15.515Z']
}, {
  field: 'kibana.alert.rule.description',
  value: ['Custom Rule']
}, {
  ...
  field: 'signal.reason',
  value: ['file event with process winlogbeat.exe, file .winlogbeat.yml.new, by SYSTEM on siem-windows-endpoint created low alert Custom Rule.']
}, {
  field: 'user.risk.calculated_score_norm',
  value: [75.22127]
}, {
