...
exports.useNetworkTopCountries = exports.ID = void 0;
...
const ID = exports.ID = 'networkTopCountriesQuery';
const useNetworkTopCountries = ({
  endDate,
  filterQuery,
  flowTarget,
  id,
  ...
  const {
    ...
    limit,
    sort
  } = (0, _use_selector.useDeepEqualSelector)(state => getTopCountriesSelector(state, type, flowTarget));
  const [networkTopCountriesRequest, setNetworkTopCountriesRequest] = (0, _react.useState)(null);
  ...
  const {
    ...
    factoryQueryType: _search_strategy.NetworkQueries.topCountries,
    initialResult: {
      edges: [],
      totalCount: -1,
      pageInfo: {
  ...
  const networkTopCountriesResponse = (0, _react.useMemo)(() => ({
    endDate,
...
exports.useNetworkTopCountries = useNetworkTopCountries;