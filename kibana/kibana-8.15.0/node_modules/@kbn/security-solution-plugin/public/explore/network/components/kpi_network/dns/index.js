...
exports.dnsStatItems = exports.NetworkKpiDns = exports.ID = void 0;
...
const ID = exports.ID = 'networkKpiDnsQuery';
const dnsStatItems = exports.dnsStatItems = [{
  key: 'dnsQueries',
  fields: [{
    key: 'dnsQueries',
...
const NetworkKpiDnsComponent = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_kpi.KpiBaseComponent, {
    id: ID,
    statItems: dnsStatItems,
    from: from,
    to: to
  });
};
const NetworkKpiDns = exports.NetworkKpiDns = /*#__PURE__*/_react.default.memo(NetworkKpiDnsComponent);