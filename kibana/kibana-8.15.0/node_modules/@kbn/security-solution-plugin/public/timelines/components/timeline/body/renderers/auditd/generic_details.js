...
const AuditdGenericLine = exports.AuditdGenericLine = /*#__PURE__*/_react.default.memo(({
  id,
  contextId,
  hostName,
  userName,
...
const AuditdGenericDetails = exports.AuditdGenericDetails = /*#__PURE__*/_react.default.memo(({
  data,
  contextId,
  isDraggable,
  text,
