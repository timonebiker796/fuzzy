...
exports.LongRunningCommandHint = void 0;
...
const LongRunningCommandHint = exports.LongRunningCommandHint = /*#__PURE__*/(0, _react.memo)(() => {
  const getTestId = (0, _use_test_id_generator.useTestIdGenerator)((0, _use_data_test_subj.useDataTestSubj)());
  return /*#__PURE__*/_react.default.createElement(_console_text.ConsoleText, {
    "data-test-subj": getTestId('longRunningCommandHint')
