...
exports.PackageActionItemError = void 0;
 ...
 */
const PackageActionItemError = exports.PackageActionItemError = /*#__PURE__*/(0, _react.memo)(({
  actionFormatter
}) => {
  return /*#__PURE__*/_react.default.createElement(StyledEuiCallout, {
    ...
    size: "s",
    "data-test-subj": "packageItemErrorCallOutMessage"
  }, actionFormatter.description, actionFormatter.linkText && actionFormatter.linkUrl && /*#__PURE__*/_react.default.createElement(_eui.EuiLink, {
    target: "_blank",
