...
exports.DataViewPickerProvider = void 0;
var _react = _interopRequireWildcard(require("react"));
var _reactRedux = require("react-redux");
var _kibana = require("../../../common/lib/kibana");
var _listeners = require("../redux/listeners");
...
const DataViewPickerProvider = exports.DataViewPickerProvider = /*#__PURE__*/(0, _react.memo)(({
  children
}) => {
  const {
    services
  ...
  (0, _react.useEffect)(() => {
    ...
    (0, _listeners.startAppListening)((0, _listeners.createInitDataviewListener)({}));
    (0, _listeners.startAppListening)((0, _listeners.createChangeDataviewListener)({
      dataViewsService: services.dataViews
    }));

    // NOTE: this can be dispatched at any point, with any data view id
    dispatch((0, _actions.init)(_constants.DEFAULT_SECURITY_SOLUTION_DATA_VIEW_ID));

    // NOTE: Clear existing listeners when services change for some reason (they should not)
    return () => _listeners.listenerMiddleware.clearListeners();
  }, [services, dispatch]);
