...
const createFilterOutCellActionFactory = ({
  ...
  const genericFilterOutActionFactory = (0, _actions.createFilterOutActionFactory)({
    filterManager,
    notifications
  });
  return genericFilterOutActionFactory.combine({
    ...
    execute: async ({
      ...
      const addFilter = (metadata === null || metadata === void 0 ? void 0 : metadata.negateFilters) === true ? _actions.addFilterIn : _actions.addFilterOut;
