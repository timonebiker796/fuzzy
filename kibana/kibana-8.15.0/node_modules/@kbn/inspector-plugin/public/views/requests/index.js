 ...
 */
const RequestsViewComponent = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./components/requests_view'))));
const getRequestsViewDescription = () => ({
