...
const getFilterField = filter => {
  ...
  if ((0, _phrase_filter.isPhraseFilter)(filter) || (0, _phrase_filter.isScriptedPhraseFilter)(filter)) {
  ...
  if ((0, _range_filter.isRangeFilter)(filter) || (0, _range_filter.isScriptedRangeFilter)(filter)) {
