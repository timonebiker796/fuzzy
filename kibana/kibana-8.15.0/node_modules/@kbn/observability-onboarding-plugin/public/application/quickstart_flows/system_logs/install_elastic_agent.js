...
function InstallElasticAgent() {
  ...
  const successfullyInstalledShipperSetup = installShipperSetupStatus === _use_fetcher.FETCH_STATUS.SUCCESS;
  const {
    data: yamlConfig = '',
  ...
  (0, _use_flow_progress_telemetry.useFlowProgressTelemetry)(progressData === null || progressData === void 0 ? void 0 : progressData.progress, 'system_logs');
  ...
  return /*#__PURE__*/_react.default.createElement(_step_panel.StepModal, {
    title: _i18n.i18n.translate('xpack.observability_onboarding.installElasticAgent.stepPanel.collectSystemLogsLabel', {
