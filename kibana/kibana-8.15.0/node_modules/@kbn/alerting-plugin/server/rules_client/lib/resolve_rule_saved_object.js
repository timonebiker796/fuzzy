...
exports.resolveRuleSavedObject = resolveRuleSavedObject;
...
async function resolveRuleSavedObject(context, params) {
  ...
  return await (0, _apmUtils.withSpan)({
    name: 'unsecuredSavedObjectsClient.resolve',
    type: 'rules'
  }, () => (0, _rule.resolveRuleSo)({
    id: ruleId,
