...
const DisabledActionGroupsByActionType = {
  [_builtin_action_groups.RecoveredActionGroup.id]: ['.jira', '.resilient']
};
const DisabledActionTypeIdsForActionGroup = exports.DisabledActionTypeIdsForActionGroup = new Map(Object.entries(DisabledActionGroupsByActionType));
