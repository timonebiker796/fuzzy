...
function registerApplicationUsageCollector(logger, usageCollection, registerType, getSavedObjectsClient, pluginStop$) {
  ...
  const collector = usageCollection.makeUsageCollector({
    ...
    fetch: async () => {
      ...
      const applicationUsageFromTotals = {};
      for await (const {
        ...
        for (const savedObject of savedObjects) {
          ...
          applicationUsageFromTotals[(0, _rollups.serializeKey)(appId, viewId)] = {
            appId,
            viewId,
      ...
      for await (const {
        ...
        for (const savedObject of savedObjects) {
          ...
          const existing = applicationUsage[(0, _rollups.serializeKey)(appId, viewId)] || {
            appId,
            viewId,
            clicks_total: 0,
            clicks_7_days: 0,
          ...
          applicationUsage[(0, _rollups.serializeKey)(appId, viewId)] = {
            ...existing,
