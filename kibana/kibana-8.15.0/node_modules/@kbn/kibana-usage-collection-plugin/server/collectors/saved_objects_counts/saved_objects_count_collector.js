...
function registerSavedObjectsCountUsageCollector(usageCollection, getAllSavedObjectTypes, getSoClientWithHiddenIndices) {
  usageCollection.registerCollector(usageCollection.makeUsageCollector({
    ...
    async fetch() {
      ...
      const {
        ...
        others
      } = await (0, _get_saved_object_counts.getSavedObjectsCounts)(soClient, allRegisteredSOTypes, {
        namespaces,
        exclusive: false
      });
      return {
