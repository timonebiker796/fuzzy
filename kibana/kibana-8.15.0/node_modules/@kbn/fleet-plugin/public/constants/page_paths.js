...
exports.pagePathGetters = exports.INTEGRATIONS_SEARCH_QUERYPARAM = exports.INTEGRATIONS_ROUTING_PATHS = exports.INTEGRATIONS_BASE_PATH = exports.FLEET_ROUTING_PATHS = exports.FLEET_BASE_PATH = void 0;
...
const FLEET_BASE_PATH = exports.FLEET_BASE_PATH = '/app/fleet';
const INTEGRATIONS_BASE_PATH = exports.INTEGRATIONS_BASE_PATH = '/app/integrations';

// If routing paths are changed here, please also check to see if
// `pagePathGetters()`, below, needs any modifications
const FLEET_ROUTING_PATHS = exports.FLEET_ROUTING_PATHS = {
  fleet: '/:tabId',
  agents: '/agents',
...
const INTEGRATIONS_SEARCH_QUERYPARAM = exports.INTEGRATIONS_SEARCH_QUERYPARAM = 'q';
const INTEGRATIONS_ROUTING_PATHS = exports.INTEGRATIONS_ROUTING_PATHS = {
  integrations: '/:tabId',
...
const pagePathGetters = exports.pagePathGetters = {
  ...
  integrations_all: ({
    ...
    const categoryPath = category && subCategory ? `/${category}/${subCategory} ` : category && !subCategory ? `/${category}` : ``;
  ...
  integration_details_overview: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/overview${integration ? `?integration=${integration}` : ''}`],
  ...
  integration_details_assets: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/assets${integration ? `?integration=${integration}` : ''}`],
  integration_details_settings: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/settings${integration ? `?integration=${integration}` : ''}`],
  integration_details_configs: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/configs${integration ? `?integration=${integration}` : ''}`],
  integration_details_custom: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/custom${integration ? `?integration=${integration}` : ''}`],
  integration_details_api_reference: ({
    pkgkey,
    integration
  }) => [INTEGRATIONS_BASE_PATH, `/detail/${pkgkey}/api-reference${integration ? `?integration=${integration}` : ''}`],
  integration_policy_edit: ({
    packagePolicyId
  }) => [INTEGRATIONS_BASE_PATH, `/edit-integration/${packagePolicyId}`],
  ...
  integration_details_language_clients: ({
    pkgkey
  }) => [INTEGRATIONS_BASE_PATH, `/language_clients/${pkgkey}/overview`],
  policies: () => [FLEET_BASE_PATH, '/policies'],
  policies_list: () => [FLEET_BASE_PATH, '/policies'],
  policy_details: ({
    policyId,
    tabId
  }) => [FLEET_BASE_PATH, `/policies/${policyId}${tabId ? `/${tabId}` : ''}`],
  add_integration_to_policy: ({
    ...
    const qs = (0, _queryString.stringify)({
      ...
      ...(useMultiPageLayout ? {
        useMultiPageLayout: null
      } : {})
    });
    return [FLEET_BASE_PATH,
    // prettier-ignore
  ...
  edit_integration: ({
    policyId,
    packagePolicyId
  }) => [FLEET_BASE_PATH, `/policies/${policyId}/edit-integration/${packagePolicyId}`],
  upgrade_package_policy: ({
    policyId,
    packagePolicyId
  }) => [FLEET_BASE_PATH, `/policies/${policyId}/upgrade-package-policy/${packagePolicyId}`],
  agent_list: ({
    kuery,
    showInactive
  }) => [FLEET_BASE_PATH, `/agents${kuery && showInactive ? `?kuery=${kuery}&showInactive=true` : showInactive ? '?showInactive=true' : ''}`],
  agent_details: ({
    agentId,
    tabId,
    logQuery
  }) => [FLEET_BASE_PATH, `/agents/${agentId}${tabId ? `/${tabId}` : ''}${logQuery ? `?_q=${logQuery}` : ''}`],
  agent_details_logs: ({
    agentId
  }) => [FLEET_BASE_PATH, `/agents/${agentId}/logs`],
  agent_details_diagnostics: ({
    agentId
  }) => [FLEET_BASE_PATH, `/agents/${agentId}/diagnostics`],
  ...
  settings_edit_fleet_server_hosts: ({
    itemId
  }) => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_edit_fleet_server_hosts.replace(':itemId', itemId.toString())],
  settings_create_fleet_server_hosts: () => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_create_fleet_server_hosts],
  settings_create_fleet_proxy: () => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_create_fleet_proxy],
  settings_edit_fleet_proxy: ({
    itemId
  }) => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_edit_fleet_proxy.replace(':itemId', itemId.toString())],
  settings_edit_outputs: ({
    outputId
  }) => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_edit_outputs.replace(':outputId', outputId)],
  settings_edit_download_sources: ({
    downloadSourceId
  }) => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_edit_download_sources.replace(':downloadSourceId', downloadSourceId)],
  settings_create_outputs: () => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_create_outputs],
  settings_create_download_sources: () => [FLEET_BASE_PATH, FLEET_ROUTING_PATHS.settings_create_download_sources],
