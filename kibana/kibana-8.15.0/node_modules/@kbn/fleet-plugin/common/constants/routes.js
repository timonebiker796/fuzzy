...
exports.UNINSTALL_TOKEN_ROUTES = exports.SETUP_API_ROUTE = exports.SETTINGS_API_ROUTES = exports.PUBLIC_API_ACCESS = exports.PRECONFIGURATION_API_ROUTES = exports.PACKAGE_POLICY_API_ROUTES = exports.PACKAGE_POLICY_API_ROOT = exports.OUTPUT_API_ROUTES = exports.MESSAGE_SIGNING_SERVICE_API_ROUTES = exports.LIMITED_CONCURRENCY_ROUTE_TAG = exports.K8S_API_ROUTES = exports.K8S_API_ROOT = exports.INTERNAL_ROOT = exports.INTERNAL_API_ACCESS = exports.INSTALL_SCRIPT_API_ROUTES = exports.FLEET_SERVER_HOST_API_ROUTES = exports.FLEET_PROXY_API_ROUTES = exports.FLEET_DEBUG_ROUTES = exports.EPM_API_ROUTES = exports.EPM_API_ROOT = exports.ENROLLMENT_API_KEY_ROUTES = exports.DOWNLOAD_SOURCE_API_ROUTES = exports.DOWNLOAD_SOURCE_API_ROOT = exports.DATA_STREAM_API_ROUTES = exports.DATA_STREAM_API_ROOT = exports.CREATE_STANDALONE_AGENT_API_KEY_ROUTE = exports.APP_API_ROUTES = exports.API_VERSIONS = exports.API_ROOT = exports.AGENT_POLICY_API_ROUTES = exports.AGENT_POLICY_API_ROOT = exports.AGENT_API_ROUTES = exports.AGENTS_SETUP_API_ROUTES = void 0;
/*
...
const INTERNAL_ROOT = exports.INTERNAL_ROOT = `/internal/fleet`;
const API_ROOT = exports.API_ROOT = `/api/fleet`;
const EPM_API_ROOT = exports.EPM_API_ROOT = `${API_ROOT}/epm`;
const DATA_STREAM_API_ROOT = exports.DATA_STREAM_API_ROOT = `${API_ROOT}/data_streams`;
const PACKAGE_POLICY_API_ROOT = exports.PACKAGE_POLICY_API_ROOT = `${API_ROOT}/package_policies`;
const AGENT_POLICY_API_ROOT = exports.AGENT_POLICY_API_ROOT = `${API_ROOT}/agent_policies`;
const K8S_API_ROOT = exports.K8S_API_ROOT = `${API_ROOT}/kubernetes`;
const DOWNLOAD_SOURCE_API_ROOT = exports.DOWNLOAD_SOURCE_API_ROOT = `${API_ROOT}/agent_download_sources`;
const LIMITED_CONCURRENCY_ROUTE_TAG = exports.LIMITED_CONCURRENCY_ROUTE_TAG = 'ingest:limited-concurrency';
...
const EPM_API_ROUTES = exports.EPM_API_ROUTES = {
...
const DATA_STREAM_API_ROUTES = exports.DATA_STREAM_API_ROUTES = {
  LIST_PATTERN: `${DATA_STREAM_API_ROOT}`
};

// Package policy API routes
const PACKAGE_POLICY_API_ROUTES = exports.PACKAGE_POLICY_API_ROUTES = {
...
const AGENT_POLICY_API_ROUTES = exports.AGENT_POLICY_API_ROUTES = {
...
const K8S_API_ROUTES = exports.K8S_API_ROUTES = {
  K8S_DOWNLOAD_PATTERN: `${K8S_API_ROOT}/download`,
  K8S_INFO_PATTERN: `${K8S_API_ROOT}`
};

// Output API routes
const OUTPUT_API_ROUTES = exports.OUTPUT_API_ROUTES = {
...
const FLEET_SERVER_HOST_API_ROUTES = exports.FLEET_SERVER_HOST_API_ROUTES = {
...
const FLEET_PROXY_API_ROUTES = exports.FLEET_PROXY_API_ROUTES = {
...
// Settings API routes
const SETTINGS_API_ROUTES = exports.SETTINGS_API_ROUTES = {
...
// App API routes
const APP_API_ROUTES = exports.APP_API_ROUTES = {
...
// Agent API routes
const AGENT_API_ROUTES = exports.AGENT_API_ROUTES = {
...
const ENROLLMENT_API_KEY_ROUTES = exports.ENROLLMENT_API_KEY_ROUTES = {
...
const UNINSTALL_TOKEN_ROUTES = exports.UNINSTALL_TOKEN_ROUTES = {
  LIST_PATTERN: `${API_ROOT}/uninstall_tokens`,
  INFO_PATTERN: `${API_ROOT}/uninstall_tokens/{uninstallTokenId}`
};

// Agents setup API routes
const AGENTS_SETUP_API_ROUTES = exports.AGENTS_SETUP_API_ROUTES = {
  INFO_PATTERN: `${API_ROOT}/agents/setup`,
  CREATE_PATTERN: `${API_ROOT}/agents/setup`
};

// Message signing service
const MESSAGE_SIGNING_SERVICE_API_ROUTES = exports.MESSAGE_SIGNING_SERVICE_API_ROUTES = {
  ROTATE_KEY_PAIR: `${API_ROOT}/message_signing_service/rotate_key_pair`
};
const SETUP_API_ROUTE = exports.SETUP_API_ROUTE = `${API_ROOT}/setup`;
const INSTALL_SCRIPT_API_ROUTES = exports.INSTALL_SCRIPT_API_ROUTES = `${API_ROOT}/install/{osType}`;

// Policy preconfig API routes
const PRECONFIGURATION_API_ROUTES = exports.PRECONFIGURATION_API_ROUTES = {
...
const DOWNLOAD_SOURCE_API_ROUTES = exports.DOWNLOAD_SOURCE_API_ROUTES = {
...
const CREATE_STANDALONE_AGENT_API_KEY_ROUTE = exports.CREATE_STANDALONE_AGENT_API_KEY_ROUTE = `${INTERNAL_ROOT}/create_standalone_agent_api_key`;

// Fleet debug routes
const FLEET_DEBUG_ROUTES = exports.FLEET_DEBUG_ROUTES = {
...
const PUBLIC_API_ACCESS = exports.PUBLIC_API_ACCESS = 'public';
const INTERNAL_API_ACCESS = exports.INTERNAL_API_ACCESS = 'internal';