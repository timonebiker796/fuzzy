...
const fleetAgentsSchema = exports.fleetAgentsSchema = {
  agents_per_version: {
    _meta: {
...
const fleetUsagesSchema = exports.fleetUsagesSchema = {
  agents_enabled: {
    type: 'boolean',
    _meta: {
  ...
  agent_policies: {
    properties: {
      ...
      avg_number_global_data_tags_per_policy: {
        type: 'long',
        _meta: {
          description: 'Average number of global data tags defined per agent policy (accross policies using global data tags)'
        }
      }
    }
  },
  ...
  license_issued_to: {
    type: 'text',
    _meta: {
      description: 'The name of the user the license is issued to'
    }
  },
  deployment_id: {
    type: 'keyword',
