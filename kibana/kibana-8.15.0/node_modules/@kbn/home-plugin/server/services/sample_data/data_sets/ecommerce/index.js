...
const ecommerceSpecProvider = ({
  ...
  return {
    ...
    previewImagePath: staticAssets.getPluginAssetHref('/sample_data_resources/ecommerce/dashboard.webp'),
    darkPreviewImagePath: staticAssets.getPluginAssetHref('/sample_data_resources/ecommerce/dashboard_dark.webp'),
