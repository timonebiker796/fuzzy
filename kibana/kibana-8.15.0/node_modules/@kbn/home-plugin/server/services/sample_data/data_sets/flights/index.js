...
const flightsSpecProvider = ({
  ...
  return {
    ...
    previewImagePath: staticAssets.getPluginAssetHref('/sample_data_resources/flights/dashboard.webp'),
    darkPreviewImagePath: staticAssets.getPluginAssetHref('/sample_data_resources/flights/dashboard_dark.webp'),
