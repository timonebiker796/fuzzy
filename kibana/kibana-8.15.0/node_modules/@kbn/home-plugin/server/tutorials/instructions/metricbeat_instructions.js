...
const createMetricbeatInstructions = exports.createMetricbeatInstructions = (0, _lodash.memoize)(context => {
  const SSL_DOC_URL = `https://www.elastic.co/guide/en/beats/metricbeat/${context.kibanaBranch}/configuration-ssl.html#ca-sha256`;
  const spaceId = (0, _get_space_id_for_beats_tutorial.getSpaceIdForBeatsTutorial)(context);
  return {
    INSTALL: {
      OSX: {
      ...
      RPM: {
        ...
        textPost: _i18n.i18n.translate('home.tutorials.common.metricbeatInstructions.install.rpmTextPost', {
          defaultMessage: 'Looking for the 32-bit packages? See the [Download page]({link}).',
          values: {
            link: 'https://www.elastic.co/downloads/beats/metricbeat'
          }
 ...
 5. From the PowerShell prompt, run the following commands to install Metricbeat as a Windows service.',
    ...
    CONFIG: {
      OSX: {
        ...
        commands: ['output.elasticsearch:', '  hosts: ["<es_url>"]', '  username: "elastic"', '  password: "<password>"', "  # If using Elasticsearch's default certificate", '  ssl.ca_trusted_fingerprint: "<es cert fingerprint>"', 'setup.kibana:', '  host: "<kibana_url>"', spaceId],
...
context => {
  var _context$spaceId;
  return `${context.kibanaBranch}|${(_context$spaceId = context.spaceId) !== null && _context$spaceId !== void 0 ? _context$spaceId : 'default'}`;
});
const createMetricbeatCloudInstructions = exports.createMetricbeatCloudInstructions = (0, _lodash.memoize)(() => ({
  CONFIG: {
    OSX: {
  ...
  return {
    instructionSets: [{
      ...
      instructionVariants: [{
        ...
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.OSX, METRICBEAT_INSTRUCTIONS.CONFIG.OSX, METRICBEAT_ENABLE_INSTRUCTIONS.OSX, METRICBEAT_INSTRUCTIONS.START.OSX]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.DEB,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.DEB, METRICBEAT_INSTRUCTIONS.CONFIG.DEB, METRICBEAT_ENABLE_INSTRUCTIONS.DEB, METRICBEAT_INSTRUCTIONS.START.DEB]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.RPM,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.RPM, METRICBEAT_INSTRUCTIONS.CONFIG.RPM, METRICBEAT_ENABLE_INSTRUCTIONS.RPM, METRICBEAT_INSTRUCTIONS.START.RPM]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.WINDOWS,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.WINDOWS, METRICBEAT_INSTRUCTIONS.CONFIG.WINDOWS, METRICBEAT_ENABLE_INSTRUCTIONS.WINDOWS, METRICBEAT_INSTRUCTIONS.START.WINDOWS]
      }],
...
function onPremCloudInstructions(moduleName, context) {
  ...
  return {
    instructionSets: [{
      ...
      instructionVariants: [{
        id: _instruction_variant.INSTRUCTION_VARIANT.OSX,
        instructions: [TRYCLOUD_OPTION1, TRYCLOUD_OPTION2, METRICBEAT_INSTRUCTIONS.INSTALL.OSX, METRICBEAT_INSTRUCTIONS.CONFIG.OSX, METRICBEAT_ENABLE_INSTRUCTIONS.OSX, METRICBEAT_INSTRUCTIONS.START.OSX]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.DEB,
        instructions: [TRYCLOUD_OPTION1, TRYCLOUD_OPTION2, METRICBEAT_INSTRUCTIONS.INSTALL.DEB, METRICBEAT_INSTRUCTIONS.CONFIG.DEB, METRICBEAT_ENABLE_INSTRUCTIONS.DEB, METRICBEAT_INSTRUCTIONS.START.DEB]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.RPM,
        instructions: [TRYCLOUD_OPTION1, TRYCLOUD_OPTION2, METRICBEAT_INSTRUCTIONS.INSTALL.RPM, METRICBEAT_INSTRUCTIONS.CONFIG.RPM, METRICBEAT_ENABLE_INSTRUCTIONS.RPM, METRICBEAT_INSTRUCTIONS.START.RPM]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.WINDOWS,
        instructions: [TRYCLOUD_OPTION1, TRYCLOUD_OPTION2, METRICBEAT_INSTRUCTIONS.INSTALL.WINDOWS, METRICBEAT_INSTRUCTIONS.CONFIG.WINDOWS, METRICBEAT_ENABLE_INSTRUCTIONS.WINDOWS, METRICBEAT_INSTRUCTIONS.START.WINDOWS]
      }],
      statusCheck: metricbeatStatusCheck(moduleName)
    }]
  };
...
function cloudInstructions(moduleName, context) {
  ...
  return {
    instructionSets: [{
      ...
      instructionVariants: [{
        id: _instruction_variant.INSTRUCTION_VARIANT.OSX,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.OSX, METRICBEAT_CLOUD_INSTRUCTIONS.CONFIG.OSX, METRICBEAT_ENABLE_INSTRUCTIONS.OSX, METRICBEAT_INSTRUCTIONS.START.OSX]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.DEB,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.DEB, METRICBEAT_CLOUD_INSTRUCTIONS.CONFIG.DEB, METRICBEAT_ENABLE_INSTRUCTIONS.DEB, METRICBEAT_INSTRUCTIONS.START.DEB]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.RPM,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.RPM, METRICBEAT_CLOUD_INSTRUCTIONS.CONFIG.RPM, METRICBEAT_ENABLE_INSTRUCTIONS.RPM, METRICBEAT_INSTRUCTIONS.START.RPM]
      }, {
        id: _instruction_variant.INSTRUCTION_VARIANT.WINDOWS,
        instructions: [METRICBEAT_INSTRUCTIONS.INSTALL.WINDOWS, METRICBEAT_CLOUD_INSTRUCTIONS.CONFIG.WINDOWS, METRICBEAT_ENABLE_INSTRUCTIONS.WINDOWS, METRICBEAT_INSTRUCTIONS.START.WINDOWS]
      }],
      statusCheck: metricbeatStatusCheck(moduleName)
    }]
  };
