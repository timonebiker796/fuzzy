  ...
  return {
    OSX: {
      ...
      textPost: _i18n.i18n.translate('home.tutorials.common.filebeatEnableInstructions.osxTextPost', {
        defaultMessage: 'Modify the settings in the `modules.d/{moduleName}.yml` file. You must enable at least one fileset.',
        values: {
          moduleName
        }
      })
    ...
    DEB: {
      ...
      textPost: _i18n.i18n.translate('home.tutorials.common.filebeatEnableInstructions.debTextPost', {
        defaultMessage: 'Modify the settings in the `/etc/filebeat/modules.d/{moduleName}.yml` file. You must enable at least one fileset.',
        values: {
          moduleName
        }
      })
