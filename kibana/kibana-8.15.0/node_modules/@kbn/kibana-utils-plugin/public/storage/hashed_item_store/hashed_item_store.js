...
class HashedItemStore {
  ...
  constructor(storage) {
    ...
    (0, _defineProperty2.default)(this, "ensuredSorting", false);
  ...
  touchHash(hash) {
    ...
    const indexedItem = this.getIndexedItem(hash, indexedItems) || {
      hash
    };
...
(0, _defineProperty2.default)(HashedItemStore, "PERSISTED_INDEX_KEY", 'kbn.hashedItemsIndex.v1');