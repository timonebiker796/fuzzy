...
const getLiveQueryResultsRequestQuerySchema = exports.getLiveQueryResultsRequestQuerySchema = t.type({
...
const getLiveQueryResultsRequestParamsSchema = exports.getLiveQueryResultsRequestParamsSchema = t.type({
  id: t.string,
  actionId: t.string
});