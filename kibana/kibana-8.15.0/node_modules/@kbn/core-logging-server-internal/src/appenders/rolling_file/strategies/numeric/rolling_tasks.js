...
exports.shouldSkipRollout = exports.rollPreviousFilesInOrder = exports.rollCurrentFile = exports.getOrderedRolledFiles = void 0;
...
const rollPreviousFilesInOrder = async ({
  ...
  for (let i = filesToRoll.length - 1; i >= 0; i--) {
    ...
    await (0, _utils.moveFile)((0, _path.join)(logFileFolder, oldFileName), (0, _path.join)(logFileFolder, newFileName));
  }
};
...
const rollCurrentFile = async ({
  ...
  await (0, _utils.moveFile)((0, _path.join)(logFileFolder, logFileBaseName), (0, _path.join)(logFileFolder, rolledBaseName));
};
