...
async function getPartitionFieldsValues(jobId, searchTerm = {}, criteriaFields, earliestMs, latestMs, fieldsConfig = {}) {
  ...
  const requestBody = {
    ...
    aggs: {
      ..._mlAnomalyUtils.ML_PARTITION_FIELDS.reduce((acc, key) => {
        return Object.assign(acc, getFieldAgg(key, isModelPlotSearch, searchTerm[key], fieldsConfig[key]));
      }, {})
    }
  };
  ...
  return _mlAnomalyUtils.ML_PARTITION_FIELDS.reduce((acc, key) => {
