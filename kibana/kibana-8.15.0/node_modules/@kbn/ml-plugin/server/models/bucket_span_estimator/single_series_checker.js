...
exports.SingleSeriesChecker = void 0;
...
class SingleSeriesChecker {
  constructor(asCurrentUser, index, timeField, aggType, field, duration, query, thresholds, runtimeMappings, indicesOptions) {
    this.index = index;
...
exports.SingleSeriesChecker = SingleSeriesChecker;