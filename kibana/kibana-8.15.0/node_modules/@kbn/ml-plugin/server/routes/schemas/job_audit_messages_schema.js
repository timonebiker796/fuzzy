...
const jobAuditMessagesJobIdSchema = exports.jobAuditMessagesJobIdSchema = _configSchema.schema.object({
  /** Job ID. */
  jobId: _configSchema.schema.maybe(_configSchema.schema.string())
});
const jobAuditMessagesQuerySchema = exports.jobAuditMessagesQuerySchema = _configSchema.schema.object({
...
const clearJobAuditMessagesBodySchema = exports.clearJobAuditMessagesBodySchema = _configSchema.schema.object({
