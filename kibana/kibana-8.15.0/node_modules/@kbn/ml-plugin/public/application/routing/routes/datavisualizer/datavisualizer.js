 ...
 * 2.0.
 */
const DatavisualizerSelector = (0, _sharedUxUtility.dynamic)(async () => ({
  default: (await Promise.resolve().then(() => _interopRequireWildcard(require('../../../datavisualizer')))).DatavisualizerSelector
}));
...
const PageWrapper = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_router.PageLoader, {
    context: context
  }, /*#__PURE__*/_react.default.createElement(DatavisualizerSelector, null));
};