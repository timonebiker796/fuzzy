 ...
 * 2.0.
 */
const FileDataVisualizerPage = (0, _sharedUxUtility.dynamic)(async () => ({
  default: (await Promise.resolve().then(() => _interopRequireWildcard(require('../../../datavisualizer/file_based')))).FileDataVisualizerPage
}));
...
const PageWrapper = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_router.PageLoader, {
    context: context
  }, /*#__PURE__*/_react.default.createElement(FileDataVisualizerPage, null));
};