 ...
 * 2.0.
 */
const DataDriftPage = (0, _sharedUxUtility.dynamic)(async () => ({
  default: (await Promise.resolve().then(() => _interopRequireWildcard(require('../../../datavisualizer/data_drift/data_drift_page')))).DataDriftPage
}));
...
const PageWrapper = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_router.PageLoader, {
    context: context
  }, /*#__PURE__*/_react.default.createElement(_ml.DataSourceContextProvider, null, /*#__PURE__*/_react.default.createElement(DataDriftPage, null)));
};