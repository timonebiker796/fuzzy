...
const CategorizationField = () => {
  ...
  const isCategorizationJob = (0, _job_creator.isCategorizationJobCreator)(jobCreator);
  (0, _react.useEffect)(() => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_categorization_field_select.CategorizationFieldSelect, {
    fields: catFields,
