...
exports.forecastServiceFactory = forecastServiceFactory;
exports.useForecastService = useForecastService;
...
function forecastServiceFactory(mlApiServices) {
  ...
  function getForecastData(job, detectorIndex, forecastId, entityFields, earliestMs, latestMs, intervalMs, aggType) {
    ...
    }, [job.job_id]).pipe((0, _rxjs.map)(resp => {
...
function useForecastService() {
  ...
  const mlForecastService = (0, _react.useMemo)(() => forecastServiceFactory(mlApiServices), [mlApiServices]);
