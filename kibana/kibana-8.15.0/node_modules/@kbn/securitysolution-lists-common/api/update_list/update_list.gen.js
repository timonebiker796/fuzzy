...
exports.UpdateListResponse = exports.UpdateListRequestBody = void 0;
...
const UpdateListRequestBody = exports.UpdateListRequestBody = _zod.z.object({
  ...
  version: _zod.z.number().int().min(1).optional(),
  _version: _zod.z.string().optional()
});
const UpdateListResponse = exports.UpdateListResponse = _list_schemas.List;