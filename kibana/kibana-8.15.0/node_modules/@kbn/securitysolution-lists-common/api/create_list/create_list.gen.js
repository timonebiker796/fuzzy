...
exports.CreateListResponse = exports.CreateListRequestBody = void 0;
...
const CreateListRequestBody = exports.CreateListRequestBody = _zod.z.object({
  ...
  version: _zod.z.number().int().min(1).optional().default(1)
});
const CreateListResponse = exports.CreateListResponse = _list_schemas.List;