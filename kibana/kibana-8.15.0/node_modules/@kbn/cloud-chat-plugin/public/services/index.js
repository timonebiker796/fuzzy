...
const ServicesContext = /*#__PURE__*/(0, _react.createContext)({});
const ServicesProvider = ({
  children,
  ...services
}) => /*#__PURE__*/_react.default.createElement(ServicesContext.Provider, {
  value: services
}, children);
...
function useServices() {
  return (0, _react.useContext)(ServicesContext);
}
function useChat() {
  const {
    chat
