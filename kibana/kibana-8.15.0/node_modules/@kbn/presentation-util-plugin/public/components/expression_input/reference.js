...
const BOLD_MD_TOKEN = '**';
const strings = {
  getArgReferenceAliasesDetail: aliases => _i18n.i18n.translate('presentationUtil.expressionInput.argReferenceAliasesDetail', {
  ...
  getArgReferenceDefaultDetail: defaultVal => _i18n.i18n.translate('presentationUtil.expressionInput.argReferenceDefaultDetail', {
  ...
  getArgReferenceRequiredDetail: required => _i18n.i18n.translate('presentationUtil.expressionInput.argReferenceRequiredDetail', {
  ...
  getArgReferenceTypesDetail: types => _i18n.i18n.translate('presentationUtil.expressionInput.argReferenceTypesDetail', {
  ...
  getFunctionReferenceAcceptsDetail: acceptTypes => _i18n.i18n.translate('presentationUtil.expressionInput.functionReferenceAccepts', {
  ...
  getFunctionReferenceReturnsDetail: returnType => _i18n.i18n.translate('presentationUtil.expressionInput.functionReferenceReturns', {
...
function getFunctionReferenceStr(fnDef) {
  ...
  const doc = `${strings.getFunctionReferenceAcceptsDetail(acceptTypes)} ${strings.getFunctionReferenceReturnsDetail(returnType)}
\n\n${help}`;
  return doc;
}
...
function getArgReferenceStr(argDef) {
  ...
  const ref = `${strings.getArgReferenceTypesDetail(typesStr)} ${strings.getArgReferenceRequiredDetail(requiredStr)}
  \n\n${secondLineArr.join(' ')}
  \n\n${help}`;
  return ref;
}