...
async function getLogEntryRateBuckets(context, logViewId, idFormat, startTime, endTime, bucketDuration, datasets) {
  const logRateJobId = (0, _log_analysis.getJobId)(context.infra.spaceId, logViewId, idFormat, _log_analysis.logEntryRateJobType);
