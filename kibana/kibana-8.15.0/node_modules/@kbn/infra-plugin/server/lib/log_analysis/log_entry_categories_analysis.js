...
async function getTopLogEntryCategories(context, logView, idFormat, startTime, endTime, categoryCount, datasets, histograms, sort) {
  const finalizeTopLogEntryCategoriesSpan = (0, _performance_tracing.startTracingSpan)('get top categories');
  const logEntryCategoriesCountJobId = (0, _log_analysis.getJobId)(context.infra.spaceId, logView.logViewId, idFormat, _log_analysis.logEntryCategoriesJobTypes[0]);
  const {
...
async function getLogEntryCategoryDatasets(context, logView, idFormat, startTime, endTime) {
  const logEntryCategoriesCountJobId = (0, _log_analysis.getJobId)(context.infra.spaceId, logView.logViewId, idFormat, _log_analysis.logEntryCategoriesJobTypes[0]);
...
async function getLogEntryCategoryExamples(context, logView, idFormat, startTime, endTime, categoryId, exampleCount, resolvedLogView) {
