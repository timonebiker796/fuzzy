...
const createConditionScript = (conditionThresholds, comparator, metric) => {
  ...
  if (comparator === _alertingComparators.COMPARATORS.BETWEEN && threshold.length === 2) {
    return {
  ...
  if (comparator === _alertingComparators.COMPARATORS.NOT_BETWEEN && threshold.length === 2) {
    return {
