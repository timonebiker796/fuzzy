...
const metricsK8sAnomalyHitRT = exports.metricsK8sAnomalyHitRT = rt.type({
  _id: rt.string,
...
const metricsK8sAnomaliesResponseRT = exports.metricsK8sAnomaliesResponseRT = rt.intersection([_elasticsearch_runtime_types.commonSearchSuccessResponseFieldsRT, rt.type({
  hits: rt.type({
