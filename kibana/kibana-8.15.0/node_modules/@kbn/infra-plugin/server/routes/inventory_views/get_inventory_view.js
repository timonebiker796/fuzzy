...
exports.initGetInventoryViewRoute = void 0;
...
const initGetInventoryViewRoute = ({
  framework,
  getStartServices
}) => {
  framework.registerRoute({
    ...
    validate: {
      params: (0, _runtime_types.createValidationFunction)(_latest.getInventoryViewRequestParamsRT),
      query: (0, _runtime_types.createValidationFunction)(_latest.inventoryViewRequestQueryRT)
    }
...
exports.initGetInventoryViewRoute = initGetInventoryViewRoute;