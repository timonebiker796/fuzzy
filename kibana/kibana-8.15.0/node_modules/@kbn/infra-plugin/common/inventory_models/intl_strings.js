...
const snapshotTypeKeys = Object.keys(_common.SnapshotMetricTypeKeys);
const SNAPSHOT_METRIC_TRANSLATIONS = exports.SNAPSHOT_METRIC_TRANSLATIONS = snapshotTypeKeys.reduce((result, metric) => {
  var _toMetricOpt;
