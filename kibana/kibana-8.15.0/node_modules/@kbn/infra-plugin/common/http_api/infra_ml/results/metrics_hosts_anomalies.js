...
const INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH = exports.INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH = '/api/infra/infra_ml/results/metrics_hosts_anomalies';
...
const getMetricsHostsAnomaliesSuccessReponsePayloadRT = exports.getMetricsHostsAnomaliesSuccessReponsePayloadRT = rt.intersection([rt.type({
...
const getMetricsHostsAnomaliesRequestPayloadRT = exports.getMetricsHostsAnomaliesRequestPayloadRT = rt.type({
  data: rt.intersection([rt.type({
