...
const badRequestErrorRT = exports.badRequestErrorRT = rt.intersection([rt.type({
...
const forbiddenErrorRT = exports.forbiddenErrorRT = rt.intersection([rt.type({
...
const conflictErrorRT = exports.conflictErrorRT = rt.intersection([rt.type({
