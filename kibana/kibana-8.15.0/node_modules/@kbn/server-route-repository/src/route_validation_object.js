...
const routeValidationObject = exports.routeValidationObject = {
  ...
  body: _configSchema.schema.nullable(_configSchema.schema.oneOf([anyObject, _configSchema.schema.string()])),
  params: anyObject,
  query: anyObject
};