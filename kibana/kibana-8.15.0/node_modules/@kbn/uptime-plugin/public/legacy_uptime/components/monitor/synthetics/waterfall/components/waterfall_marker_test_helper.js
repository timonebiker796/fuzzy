...
const TestWrapper = ({
  ...
  activeStep,
  children
}) => /*#__PURE__*/_react.default.createElement(_contexts.UptimeStartupPluginsContext.Provider, {
  value: {
...
}, /*#__PURE__*/_react.default.createElement(_waterfall_chart.WaterfallContext.Provider, {
  value: {
    activeStep
  }
}, children));
