...
exports.evalFunctionDefinitions = void 0;
...
const dateDiffDefinition = {
  ...
  signatures: [{
    params: [{
      ...
      type: 'string',
      optional: false,
      literalOptions: ['year', 'years', 'yy', 'yyyy', 'quarter', 'quarters', 'qq', 'q', 'month', 'months', 'mm', 'm', 'dayofyear', 'dy', 'y', 'day', 'days', 'dd', 'd', 'week', 'weeks', 'wk', 'ww', 'weekday', 'weekdays', 'dw', 'hour', 'hours', 'hh', 'minute', 'minutes', 'mi', 'n', 'second', 'seconds', 'ss', 's', 'millisecond', 'milliseconds', 'ms', 'microsecond', 'microseconds', 'mcs', 'nanosecond', 'nanoseconds', 'ns'],
...
const logDefinition = {
  ...
  validate: fnDef => {
    ...
    for (const arg of fnDef.args) {
      if ((0, _helpers.isLiteralItem)(arg) && arg.value < 0) {
        messages.push({
          type: 'warning',
...
const evalFunctionDefinitions = exports.evalFunctionDefinitions = [absDefinition, acosDefinition, asinDefinition, atanDefinition, atan2Definition, cbrtDefinition, ceilDefinition, cidrMatchDefinition, coalesceDefinition, concatDefinition, cosDefinition, coshDefinition, dateDiffDefinition, dateExtractDefinition, dateFormatDefinition, dateParseDefinition, dateTruncDefinition, eDefinition, endsWithDefinition, floorDefinition, fromBase64Definition, greatestDefinition, ipPrefixDefinition, leastDefinition, leftDefinition, lengthDefinition, locateDefinition, logDefinition, log10Definition, ltrimDefinition, mvAppendDefinition, mvAvgDefinition, mvConcatDefinition, mvCountDefinition, mvDedupeDefinition, mvFirstDefinition, mvLastDefinition, mvMaxDefinition, mvMedianDefinition, mvMinDefinition, mvSliceDefinition, mvSortDefinition, mvSumDefinition, mvZipDefinition, nowDefinition, piDefinition, powDefinition, repeatDefinition, replaceDefinition, rightDefinition, roundDefinition, rtrimDefinition, signumDefinition, sinDefinition, sinhDefinition, splitDefinition, sqrtDefinition, stContainsDefinition, stDisjointDefinition, stDistanceDefinition, stIntersectsDefinition, stWithinDefinition, stXDefinition, stYDefinition, startsWithDefinition, substringDefinition, tanDefinition, tanhDefinition, tauDefinition, toBase64Definition, toBooleanDefinition, toCartesianpointDefinition, toCartesianshapeDefinition, toDatetimeDefinition, toDegreesDefinition, toDoubleDefinition, toGeopointDefinition, toGeoshapeDefinition, toIntegerDefinition, toIpDefinition, toLongDefinition, toLowerDefinition, toRadiansDefinition, toStringDefinition, toUnsignedLongDefinition, toUpperDefinition, toVersionDefinition, trimDefinition, caseDefinition];