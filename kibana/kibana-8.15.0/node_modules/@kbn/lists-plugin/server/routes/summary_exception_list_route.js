...
const summaryExceptionListRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.summaryExceptionListRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id != null || listId != null) {
        ...
        if (exceptionListSummary == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionListSummary, _api.summaryExceptionListResponse);
          if (errors != null) {
            return response.ok({
