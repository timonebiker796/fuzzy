...
const updateExceptionListRoute = router => {
  router.versioned.put({
    ...
    validate: {
      request: {
        body: (0, _utils.buildRouteValidation)(_api.updateExceptionListRequest)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id == null && listId == null) {
        ...
        if (list == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(list, _api.updateExceptionListResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
