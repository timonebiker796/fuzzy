...
const findEndpointListItemRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.findEndpointListItemRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionListItems, _api.findEndpointListItemResponse);
      if (errors != null) {
        return siemResponse.error({
          body: errors,
          statusCode: 500
