...
const readExceptionListRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.readExceptionListRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id != null || listId != null) {
        ...
        if (exceptionList == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionList, _api.readExceptionListResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
