...
const updateExceptionListItemRoute = router => {
  router.versioned.put({
    ...
    validate: {
      request: {
        body: (0, _utils.buildRouteValidation)(_api.updateExceptionListItemRequest)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id == null && itemId == null) {
        ...
        if (exceptionListItem == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionListItem, _api.updateExceptionListItemResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
