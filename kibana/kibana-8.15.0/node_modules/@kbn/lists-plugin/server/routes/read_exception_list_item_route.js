...
const readExceptionListItemRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.readExceptionListItemRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id != null || itemId != null) {
        ...
        if (exceptionListItem == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionListItem, _api.readExceptionListItemResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
