...
const createEndpointListItemRoute = router => {
  router.versioned.post({
    ...
    validate: {
      request: {
        body: (0, _utils.buildRouteValidation)(_api.createEndpointListItemRequest)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (exceptionListItem != null) {
        ...
        const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(createdList, _api.createEndpointListItemResponse);
        if (errors != null) {
          return siemResponse.error({
            body: errors,
            statusCode: 500
