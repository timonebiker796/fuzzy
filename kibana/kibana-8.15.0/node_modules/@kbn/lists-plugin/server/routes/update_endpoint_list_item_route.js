...
const updateEndpointListItemRoute = router => {
  router.versioned.put({
    ...
    validate: {
      request: {
        body: (0, _utils.buildRouteValidation)(_api.updateEndpointListItemRequest)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (exceptionListItem == null) {
        ...
        const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionListItem, _api.updateEndpointListItemResponse);
        if (errors != null) {
          return siemResponse.error({
            body: errors,
            statusCode: 500
