...
const deleteExceptionListItemRoute = router => {
  router.versioned.delete({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.deleteExceptionListItemRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (itemId == null && id == null) {
        ...
        if (deleted == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(deleted, _api.deleteExceptionListItemResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
