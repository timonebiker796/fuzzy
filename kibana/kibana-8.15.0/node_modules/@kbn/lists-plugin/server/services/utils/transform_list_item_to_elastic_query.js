...
const DEFAULT_DATE_REGEX = exports.DEFAULT_DATE_REGEX = RegExp('(?<gte>.+),(?<lte>.+)|(?<value>.+)');
const DEFAULT_LTE_GTE_REGEX = exports.DEFAULT_LTE_GTE_REGEX = RegExp('(?<gte>.+)-(?<lte>.+)|(?<value>.+)');
const DEFAULT_GEO_REGEX = exports.DEFAULT_GEO_REGEX = RegExp('(?<lat>.+),(?<lon>.+)');
const DEFAULT_SINGLE_REGEX = exports.DEFAULT_SINGLE_REGEX = RegExp('(?<value>.+)');
