 ...
 */
const SESSION_INDEX_MAPPINGS_VERSION_META_FIELD_NAME = exports.SESSION_INDEX_MAPPINGS_VERSION_META_FIELD_NAME = 'security-version';
  ...
  async create(sessionValue) {
    ...
    try {
      ...
      if (statusCode === 404) {
        ...
        if (statusCode !== 201) {
          this.options.logger.error(`Failed to write a new session (status code: ${statusCode}): ${JSON.stringify(body)}.`);
        }
      }
      return {
        ...sessionValue,
