...
exports.defineSecurityFeatureCheckRoute = defineSecurityFeatureCheckRoute;
...
function defineSecurityFeatureCheckRoute({
  router,
  logger
}) {
  router.get({
...
async function getEnabledSecurityFeatures(esClient, logger) {
