...
var _painless_lexer; // @ts-nocheck
// Generated from ./src/painless/antlr/painless_lexer.g4 by ANTLR 4.13.1
// noinspection ES6UnusedImports,JSUnusedGlobalSymbols,JSUnusedLocalSymbols
class painless_lexer extends _antlr.Lexer {
  constructor(input) {
    super(input);
    this._interp = new _antlr.LexerATNSimulator(this, painless_lexer._ATN, painless_lexer.DecisionsToDFA, new _antlr.PredictionContextCache());
  }
  get grammarFileName() {
  ...
  static get _ATN() {
    if (!painless_lexer.__ATN) {
      painless_lexer.__ATN = new _antlr.ATNDeserializer().deserialize(painless_lexer._serializedATN);
    }
    return painless_lexer.__ATN;
  }
}
exports.default = painless_lexer;
...
(0, _defineProperty2.default)(painless_lexer, "EOF", _antlr.Token.EOF);
...
(0, _defineProperty2.default)(painless_lexer, "literalNames", [null, null, null, "'{'", "'}'", "'['", "']'", "'('", "')'", "'$'", "'.'", "'?.'", "','", "';'", "'if'", "'in'", "'else'", "'while'", "'do'", "'for'", "'continue'", "'break'", "'return'", "'new'", "'try'", "'catch'", "'throw'", "'this'", "'instanceof'", "'!'", "'~'", "'*'", "'/'", "'%'", "'+'", "'-'", "'<<'", "'>>'", "'>>>'", "'<'", "'<='", "'>'", "'>='", "'=='", "'==='", "'!='", "'!=='", "'&'", "'^'", "'|'", "'&&'", "'||'", "'?'", "':'", "'?:'", "'::'", "'->'", "'=~'", "'==~'", "'++'", "'--'", "'='", "'+='", "'-='", "'*='", "'/='", "'%='", "'&='", "'^='", "'|='", "'<<='", "'>>='", "'>>>='", null, null, null, null, null, null, "'true'", "'false'", "'null'", null, "'def'"]);
...
(0, _defineProperty2.default)(painless_lexer, "DecisionsToDFA", _painless_lexer._ATN.decisionToState.map((ds, index) => new _antlr.DFA(ds, index)));
