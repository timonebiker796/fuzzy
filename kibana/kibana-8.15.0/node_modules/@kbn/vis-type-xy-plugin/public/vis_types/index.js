 ...
 */
const visTypesDefinitions = exports.visTypesDefinitions = [_area.areaVisTypeDefinition, _line.lineVisTypeDefinition, _histogram.histogramVisTypeDefinition, _horizontal_bar.horizontalBarVisTypeDefinition].map(defenition => {
  return {
    ...defenition,
