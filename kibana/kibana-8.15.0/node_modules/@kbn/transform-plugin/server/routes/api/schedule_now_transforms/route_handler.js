...
var _schedule_now_transforms = require("./schedule_now_transforms");
/*
...
const routeHandler = async (ctx, req, res) => {
  ...
  try {
    ...
    return res.ok({
      body: await (0, _schedule_now_transforms.scheduleNowTransforms)(transformsInfo, esClient.asCurrentUser)
    });
  } catch (e) {
