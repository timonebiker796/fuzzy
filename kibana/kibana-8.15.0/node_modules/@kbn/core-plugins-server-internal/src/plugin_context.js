...
function createPluginInitializerContext({
  ...
  return {
    ...
    config: {
       ...
       */
      create() {
        return coreContext.configService.atPath(manifest.configPath).pipe((0, _rxjs.shareReplay)(1));
      },
      get() {
...
function createPluginSetupContext({
  ...
  return {
    ...
    http: {
      ...
      basePath: deps.http.basePath,
      staticAssets: {
        prependPublicUrl: pathname => deps.http.staticAssets.prependPublicUrl(pathname),
    ...
    userProfile: {
      registerUserProfileDelegate: delegate => deps.userProfile.registerUserProfileDelegate(delegate)
    }
  };
}
