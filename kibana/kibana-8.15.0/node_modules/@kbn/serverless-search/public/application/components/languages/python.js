...
const pythonDefinition = exports.pythonDefinition = {
  apiReference: _doc_links.docLinks.pythonApiReference,
  basicConfig: _doc_links.docLinks.pythonBasicConfig,
...
client = Elasticsearch(
  ...
  docLink: _doc_links.docLinks.pythonClient,
  github: {
    link: 'https://github.com/elastic/elasticsearch-serverless-python',
    label: _i18n.i18n.translate('xpack.serverlessSearch.languages.python.githubLabel', {
...
documents = [
  {"index": {"_index": "${indexName !== null && indexName !== void 0 ? indexName : _constants.INDEX_NAME_PLACEHOLDER}"}},
  {"name": "foo", "title": "bar"},
]
...
# python -m pip install elasticsearch_serverless[async]
  `,
  name: _i18n.i18n.translate('xpack.serverlessSearch.languages.python', {
