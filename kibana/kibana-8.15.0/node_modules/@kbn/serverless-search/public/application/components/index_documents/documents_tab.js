...
exports.createIndexDocumentsContent = void 0;
 ...
 * 2.0.
 */
const IndexDocuments = /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./documents'))));
const createIndexDocumentsContent = (core, services) => {
  return {
    id: 'documents',
    ...
    renderTabContent: ({
      ...
      }, /*#__PURE__*/_react.default.createElement(IndexDocuments, {
        indexName: index.name
      }))));
    }
  };
};
exports.createIndexDocumentsContent = createIndexDocumentsContent;