...
exports.parseBedrockBuffer = exports.handleBedrockChunk = void 0;
 ...
 */
exports.parseBedrockBuffer = parseBedrockBuffer;
...
const prepareBedrockOutput = (responseBody, logger) => {
  ...
  logger === null || logger === void 0 ? void 0 : logger.warn(`Failed to parse bedrock chunk ${JSON.stringify(responseBody)}`);
  return '';
};
