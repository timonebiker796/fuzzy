...
class AuthHeadersStorage {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "set", (request, headers) => {
      this.authHeadersCache.set((0, _coreHttpRouterServerInternal.ensureRawRequest)(request), headers);
    });
    (0, _defineProperty2.default)(this, "get", request => {
      return this.authHeadersCache.get((0, _coreHttpRouterServerInternal.ensureRawRequest)(request));
    });
  }
}
