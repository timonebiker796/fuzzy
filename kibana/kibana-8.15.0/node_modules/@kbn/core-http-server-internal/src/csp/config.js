...
const configSchema = _configSchema.schema.object({
  ...
  report_only: _configSchema.schema.maybe(_configSchema.schema.object({
    form_action: _configSchema.schema.arrayOf(_configSchema.schema.string(), {
      defaultValue: [],
      validate: getDirectiveValidator({
        allowNone: false,
        allowNonce: false
...
const cspConfig = exports.cspConfig = {
