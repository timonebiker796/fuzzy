...
const getUiSettings = (docLinks, enableValidations) => ({
  ...
  [_discoverUtils.DOC_TABLE_LEGACY]: {
    ...
    deprecation: {
      message: _i18n.i18n.translate('discover.advancedSettings.discover.disableDocumentExplorerDeprecation', {
  ...
  [_discoverUtils.SEARCH_FIELDS_FROM_SOURCE]: {
    ...
    schema: _configSchema.schema.boolean(),
    deprecation: {
      message: _i18n.i18n.translate('discover.advancedSettings.discover.readFieldsFromSourceDeprecation', {
        defaultMessage: 'This setting is deprecated and will be removed in Kibana 9.0.'
      }),
      docLinksKey: 'discoverSettings'
    }
