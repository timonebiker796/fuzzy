...
exports.ContainerMetricsTable = void 0;
...
const ContainerMetricsTable = props => {
  const {
    data,
    isLoading,
    setCurrentPageIndex,
  ...
  const columns = (0, _react.useMemo)(() => containerNodeColumns(timerange), [timerange]);
  const sortSettings = {
  ...
  if (data.state === 'error') {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiBasicTable, {
      tableCaption: _i18n.i18n.translate('xpack.metricsData.metricsTable.container.tableCaption', {
      ...
      ariaLabel: _i18n.i18n.translate('xpack.metricsData.metricsTable.container.paginationAriaLabel', {
...
exports.ContainerMetricsTable = ContainerMetricsTable;
function containerNodeColumns(timerange) {
  return [{
    name: _i18n.i18n.translate('xpack.metricsData.metricsTable.container.idColumnHeader', {
      defaultMessage: 'Id'
    }),
    field: 'id',
    truncateText: true,
    ...
    name: _i18n.i18n.translate('xpack.metricsData.metricsTable.container.averageCpuUsagePercentColumnHeader', {
    ...
    name: _i18n.i18n.translate('xpack.metricsData.metricsTable.container.averageMemoryUsageMegabytesColumnHeader', {
