...
const CLIENT_DEFAULTS = exports.CLIENT_DEFAULTS = {
...
const EXCLUDE_RUN_ONCE_FILTER = exports.EXCLUDE_RUN_ONCE_FILTER = {
  bool: {
    must_not: {
      exists: {
        field: 'run_once'
...
const FINAL_SUMMARY_FILTER = exports.FINAL_SUMMARY_FILTER = {
  bool: {
    filter: [{
      exists: {
        field: 'summary'
...
const SUMMARY_FILTER = exports.SUMMARY_FILTER = {
  exists: {
    field: 'summary'
  }
};
