 ...
 */
let ML_JOB_AGGREGATION = exports.ML_JOB_AGGREGATION = /*#__PURE__*/function (ML_JOB_AGGREGATION) {
  ...
  return ML_JOB_AGGREGATION;
}({});
/**
 * Custom enum for sparse data aggregations.
 */
const SPARSE_DATA_AGGREGATIONS = exports.SPARSE_DATA_AGGREGATIONS = [ML_JOB_AGGREGATION.NON_ZERO_COUNT, ML_JOB_AGGREGATION.HIGH_NON_ZERO_COUNT, ML_JOB_AGGREGATION.LOW_NON_ZERO_COUNT, ML_JOB_AGGREGATION.NON_NULL_SUM, ML_JOB_AGGREGATION.HIGH_NON_NULL_SUM, ML_JOB_AGGREGATION.LOW_NON_NULL_SUM];
 ...
 */
let KIBANA_AGGREGATION = exports.KIBANA_AGGREGATION = /*#__PURE__*/function (KIBANA_AGGREGATION) {
  ...
  return KIBANA_AGGREGATION;
}({});
/**
 * Enum for ES aggregatins.
 */
let ES_AGGREGATION = exports.ES_AGGREGATION = /*#__PURE__*/function (ES_AGGREGATION) {
 ...
 */
const mlJobAggregationsWithoutEsEquivalent = exports.mlJobAggregationsWithoutEsEquivalent = [{
 ...
 */
const mlJobAggregations = exports.mlJobAggregations = [{
