...
class SearchPlaygroundPlugin {
  ...
  start(core, deps) {
    ...
    return {
      PlaygroundProvider: (0, _embeddable.getPlaygroundProvider)(core, deps),
      Playground: _embeddable.Playground,
      PlaygroundHeaderDocs: _playground_header_docs.PlaygroundHeaderDocs
    };
  }
  stop() {}
}
