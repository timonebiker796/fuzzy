...
var _query_client = require("../utils/query_client");
var _form_provider = require("./form_provider");
/*
...
const PlaygroundProvider = ({
  ...
  }, /*#__PURE__*/_react.default.createElement(_form_provider.FormProvider, null, children));
};
