...
exports.formatErrors = exports.createRouteValidationFunction = void 0;
...
const createRouteValidationFunction = runtimeType => (inputValue, {
  badRequest,
  ok
}) => (0, _pipeable.pipe)(runtimeType.decode(inputValue), (0, _Either.fold)(errors => badRequest(formatErrors(errors)), result => ok(result)));
exports.createRouteValidationFunction = createRouteValidationFunction;
