...
const getVisualizationSearchSourceMigrations = searchSourceMigrations => (0, _lodash.mapValues)(searchSourceMigrations, migrate => state => {
  var _state$attributes$kib;
  const _state = state;
  const parsedSearchSourceJSON = JSON.parse(((_state$attributes$kib = _state.attributes.kibanaSavedObjectMeta) === null || _state$attributes$kib === void 0 ? void 0 : _state$attributes$kib.searchSourceJSON) || '{}');
