...
exports.runPanelPlacementStrategy = void 0;
...
const runPanelPlacementStrategy = (strategy, {
  width,
  height,
  currentPanels
}) => {
  switch (strategy) {
    case _dashboard_constants.PanelPlacementStrategy.placeAtTop:
      const otherPanels = {
        ...currentPanels
      };
    ...
    case _dashboard_constants.PanelPlacementStrategy.findTopLeftMostOpenSpace:
      let maxY = -1;
    ...
    default:
      throw new Error(_dashboard_container_strings.panelPlacementStrings.getUnknownStrategyError(strategy));
  }
};
exports.runPanelPlacementStrategy = runPanelPlacementStrategy;