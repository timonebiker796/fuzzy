...
const handleErrors = handler => async (context, request, response) => {
  try {
    ...
    if (error instanceof Error) {
      ...
      const is404 = error.is404 || (error === null || error === void 0 ? void 0 : (_output = error.output) === null || _output === void 0 ? void 0 : _output.statusCode) === 404 || error instanceof _common.SavedObjectNotFound;
      if (is404) {
