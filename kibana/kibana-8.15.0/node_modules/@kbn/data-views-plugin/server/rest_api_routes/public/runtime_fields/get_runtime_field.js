...
const getRuntimeField = async ({
  ...
  return {
    dataView,
    fields: Object.values(dataView.getRuntimeFields({
      fieldName: [name]
    }))
  };
};
exports.getRuntimeField = getRuntimeField;
const getRuntimeFieldRouteFactory = (path, serviceKey, description) => (router, getStartServices, usageCollection) => {
...
const registerGetRuntimeFieldRoute = exports.registerGetRuntimeFieldRoute = getRuntimeFieldRouteFactory(_constants.SPECIFIC_RUNTIME_FIELD_PATH, _constants.SERVICE_KEY, _constants.GET_RUNTIME_FIELD_DESCRIPTION);
const registerGetRuntimeFieldRouteLegacy = exports.registerGetRuntimeFieldRouteLegacy = getRuntimeFieldRouteFactory(_constants.SPECIFIC_RUNTIME_FIELD_PATH_LEGACY, _constants.SERVICE_KEY_LEGACY);