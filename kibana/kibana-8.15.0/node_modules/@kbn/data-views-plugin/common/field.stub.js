...
const stubFieldSpecMap = exports.stubFieldSpecMap = {
  'machine.os': {
    name: 'machine.os',
    customLabel: 'OS',
    esTypes: ['text'],
...
const stubFields = exports.stubFields = Object.values(stubFieldSpecMap).map(spec => createIndexPatternFieldStub({
  spec
}));
const stubLogstashFieldSpecMap = exports.stubLogstashFieldSpecMap = {
  bytes: {
    name: 'bytes',
    type: 'number',
    esTypes: ['long'],
...
const stubLogstashFields = exports.stubLogstashFields = Object.values(stubLogstashFieldSpecMap).map(spec => createIndexPatternFieldStub({
  spec
}));