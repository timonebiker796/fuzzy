...
const getTargetIndices = ({
  ...
  return [...new Set(types.map(type => (0, _coreSavedObjectsBaseServerInternal.getIndexForType)({
    type,
    typeRegistry,
    kibanaVersion,
...
const getUnknownSavedObjects = async ({
  ...
  const excludeRegisteredTypes = (0, _coreSavedObjectsMigrationServerInternal.addExcludedTypesToBoolQuery)(knownTypes);
  return await (0, _coreSavedObjectsMigrationServerInternal.getAggregatedTypesDocuments)(esClient.asInternalUser, targetIndices, excludeRegisteredTypes);
};
...
const deleteUnknownTypeObjects = async ({
  ...
  const nonRegisteredTypesQuery = (0, _coreSavedObjectsMigrationServerInternal.addExcludedTypesToBoolQuery)(knownTypes);
