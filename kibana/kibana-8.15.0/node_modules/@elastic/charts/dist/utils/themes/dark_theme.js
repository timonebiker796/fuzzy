...
exports.DARK_THEME = {
    ...
    lineSeriesStyle: {
        ...
        point: {
            ...
            strokeWidth: 2,
            fill: base_colors_1.DARK_BASE_COLORS.emptyShade,
            radius: 3,
            opacity: 1,
        },
        isolatedPoint: {
    ...
    axes: {
        axisTitle: {
            ...
            fill: base_colors_1.DARK_BASE_COLORS.title,
            visible: true,
        },
        axisPanelTitle: {
            fontSize: 10,
        ...
        axisLine: {
            visible: true,
            stroke: base_colors_1.DARK_BASE_COLORS.lightShade,
            strokeWidth: 1,
        },
        tickLabel: {
            visible: true,
    ...
    crosshair: {
        ...
        line: {
            visible: true,
            stroke: base_colors_1.DARK_BASE_COLORS.darkShade,
            strokeWidth: 1,
            dash: [4, 4],
        },
        crossLine: {
    ...
    background: {
        color: base_colors_1.DARK_BASE_COLORS.emptyShade,
        fallbackColor: base_colors_1.DARK_BASE_COLORS.emptyShade,
    },
    goal: {
        minFontSize: 8,
        maxFontSize: 64,
        ...
        tickLine: {
            stroke: base_colors_1.DARK_BASE_COLORS.mediumShade,
        },
        progressLine: {
            stroke: '#D4DAE5',
        },
    ...
    partition: {
        ...
        linkLabel: {
            ...
            maxCount: 5,
            maxTextLength: 100,
            textColor: base_colors_1.DARK_BASE_COLORS.title,
            minimumStemLength: 0,
        ...
        sectorLineWidth: 1.5,
        sectorLineStroke: base_colors_1.DARK_BASE_COLORS.emptyShade,
    },
    heatmap: {
        brushArea: {
            visible: true,
    ...
    metric: {
        ...
        textDarkColor: base_colors_1.DARK_BASE_COLORS.lightShade,
        ...
        barBackground: base_colors_1.DARK_BASE_COLORS.lightShade,
        emptyBackground: colors_2.Colors.Transparent.keyword,
        nonFiniteText: 'N/A',
        minHeight: 64,
    },
    ...
    flamegraph: {
        ...
        scrollbarThumb: base_colors_1.DARK_BASE_COLORS.title,
        scrollbarTrack: base_colors_1.DARK_BASE_COLORS.lightShade,
    },
    highlighter: {
        point: {
            opacity: 1,
    ...
    rectAnnotation: {
        strokeWidth: 0,
        opacity: 0.25,
        fill: base_colors_1.DARK_BASE_COLORS.darkShade,
        stroke: base_colors_1.DARK_BASE_COLORS.darkShade,
    },
};
