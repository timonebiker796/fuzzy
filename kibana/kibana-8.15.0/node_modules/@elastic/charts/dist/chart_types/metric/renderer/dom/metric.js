...
const Metric = ({ chartId, hasTitles, rowIndex, columnIndex, totalColumns, totalRows, datum, panel, style, backgroundColor: chartBackgroundColor, contrastOptions, locale, onElementClick, onElementOver, onElementOut, }) => {
    ...
    const containerClassName = (0, classnames_1.default)('echMetric', {
        ...
        [`echMetric--withTargetProgressBar--${progressBarSize}`]: !(0, common_1.isNil)(datum === null || datum === void 0 ? void 0 : datum.target),
    });
    ...
    return (react_1.default.createElement("div", { role: "figure", "aria-labelledby": datum.title && metricHTMLId, className: containerClassName, style: containerStyle, onMouseLeave: () => {
        ...
        react_1.default.createElement(text_1.MetricText, { id: metricHTMLId, datum: datumWithInteractionColor, panel: panel, style: style, onElementClick: onElementClick ? onElementClickHandler : undefined, progressBarSize: progressBarSize, highContrastTextColor: finalTextColor.keyword, locale: locale }),
