    ...
    render() {
        ...
        return (react_1.default.createElement("svg", { className: "echHighlighter", style: { zIndex } },
            ...
            highlightedGeometries.map((geom, i) => {
                ...
                return (react_1.default.createElement("rect", { key: i, x: x, y: geom.y, width: geom.width, height: geom.height, transform: geomTransform, className: "echHighlighterOverlay__fill", clipPath: `url(#${clipPathId})` }));
            })));
    }
}
