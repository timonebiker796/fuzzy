...
function renderLine(shift, dataSeries, xScale, yScale, panel, color, curve, hasY0Accessors, xScaleOffset, style, markSizeOptions, hasFit, pointStyleAccessor) {
    ...
    const { pointGeometries, indexedGeometryMap } = (0, points_1.renderPoints)(shift - xScaleOffset, dataSeries, xScale, yScale, panel, color, style.point, style.isolatedPoint, hasY0Accessors, markSizeOptions, false, style.isolatedPoint.enabled, pointStyleAccessor);
