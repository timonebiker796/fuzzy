...
], ({ geometries }, legend, axes, gridLines, axesSpecs, { rotation, locale }, annotations, theme) => {
...
function getAnnotationsState({ lineAnnotation, rectAnnotation }, annotationSpecs) {
    return annotationSpecs.flatMap((annotation) => {
        return annotation.dataValues.map((dataValue) => ({
            ...
            style: annotation.annotationType === specs_1.AnnotationType.Line
                ? (0, merge_utils_1.mergeWithDefaultAnnotationLine)(lineAnnotation, annotation === null || annotation === void 0 ? void 0 : annotation.style)
                : (0, merge_utils_1.mergeWithDefaultAnnotationRect)(rectAnnotation, annotation === null || annotation === void 0 ? void 0 : annotation.style),
