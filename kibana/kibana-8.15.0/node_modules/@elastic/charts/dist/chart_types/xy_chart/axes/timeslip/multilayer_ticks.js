...
function multilayerAxisEntry(xDomain, extendByOneBin, range, timeAxisLayerCount, scale, getMeasuredTicks, locale, dow) {
    const rasterSelector = (0, continuous_time_rasters_1.continuousTimeRasters)({ minimumTickPixelDistance: exports.MINIMUM_TICK_PIXEL_DISTANCE, locale, dow }, xDomain.timeZone);
