...
function renderPoints(shift, dataSeries, xScale, yScale, panel, color, pointStyle, isolatedPointThemeStyle, isBandedSpec, markSizeOptions, useSpatialIndex, allowIsolated, styleAccessor) {
    ...
    const pointGeometries = dataSeries.data.reduce((acc, datum, dataIndex) => {
        ...
        yDatumKeyNames.forEach((yDatumKeyName, keyIndex) => {
            ...
            const isolatedPointStyle = (0, point_style_1.buildPointGeometryStyles)(color, isolatedPointThemeStyle, styleOverrides);
