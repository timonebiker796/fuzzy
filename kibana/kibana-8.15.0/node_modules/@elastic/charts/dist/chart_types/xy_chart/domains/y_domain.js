...
exports.coerceYScaleTypes = exports.isStackedSpec = exports.hasHistogramBarSpec = exports.groupSeriesByYGroup = exports.mergeYDomain = void 0;
...
function hasHistogramBarSpec(specs) {
    return specs.some(({ seriesType, enableHistogramMode }) => seriesType === specs_1.SeriesType.Bar && enableHistogramMode);
}
exports.hasHistogramBarSpec = hasHistogramBarSpec;
function isStackedSpec(spec) {
