...
function getVisibleTickSets({ rotation: chartRotation, locale, dow }, joinedAxesData, { xDomain, yDomains }, smScales, totalGroupsCount, enableHistogramMode, barsPadding) {
    return (0, canvas_text_bbox_calculator_1.withTextMeasure)((textMeasure) => {
        ...
        return [...joinedAxesData].reduce((acc, [axisId, { axisSpec, axesStyle, gridLine, isXAxis, labelFormatter: userProvidedLabelFormatter }]) => {
            ...
            const maximumFractionDigits = mfd !== null && mfd !== void 0 ? mfd : (integersOnly ? 0 : undefined);
            ...
            const getScale = (desiredTickCount) => isXAxis
                ...
                : yDomain &&
                    new scales_1.ScaleContinuous({ ...yDomain, range }, { ...yDomain, desiredTickCount, maximumFractionDigits });
            ...
            if (isMultilayerTimeAxis) {
                ...
                return acc.set(axisId, (0, multilayer_ticks_1.multilayerAxisEntry)(xDomain, isXAxis && xDomain.isBandScale && enableHistogramMode, range, timeAxisLayerCount, scale, getMeasuredTicks, locale, dow));
            }
