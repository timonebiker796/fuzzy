...
function computeAnnotationDimensions(annotations, { rotation: chartRotation }, { scales: { xScale, yScales } }, axesSpecs, { lineAnnotation: lineAnnotationStyle }, isHistogramModeEnabled, smallMultipleScales, getAxisStyle) {
    return annotations.reduce((annotationDimensions, annotationSpec) => {
        ...
        if ((0, specs_1.isLineAnnotation)(annotationSpec)) {
            ...
            const dimensions = (0, dimensions_1.computeLineAnnotationDimensions)(annotationSpec, chartRotation, yScales, xScale, smallMultipleScales, lineAnnotationStyle, isHistogramModeEnabled, annotationAxisPosition);
            if (dimensions) {
